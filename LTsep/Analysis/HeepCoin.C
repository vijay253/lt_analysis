  ...
  for(Long64_t i = 0; i < nEntries_TBRANCH; i++)
    {
      ...
      epicointime =  CTime_ePiCoinTime_ROC1 >= 43.0 && CTime_ePiCoinTime_ROC1 <= 45.0;// && H_cer_npeSum >= 0.0;
      epicointimeRandom  = CTime_ePiCoinTime_ROC1 >= 33.0 && CTime_ePiCoinTime_ROC1 <= 35.0;   //0.6
