...
void Analysed(string RunNum = "", Double_t Coin_trig_rate = 0, Double_t EDTMLIVE = 0, Double_t EDTMLIVEERR = 0, Double_t CPULIVE = 0, Double_t CPULIVEERR = 0, Double_t I = 0, Double_t SHMS3Y4 = 0, Double_t SHMSHOD1 = 0, Double_t SHMSHOD2 =0, Double_t SHMSHOD3 =0, Double_t SHMSHOD4 =0)
{
  ...
  file<< RunNum <<"\t"<< EDTMLIVE <<"\t"<< EDTMLIVEERR << "\t"<< CPULIVE << "\t" << CPULIVEERR <<"\t"<< Coin_trig_rate <<"\t"<< I <<"\t"<< SHMS3Y4<<"\t"<<SHMSHOD1<<"\t"<<SHMSHOD2<<"\t"<<SHMSHOD3<<"\t"<<SHMSHOD4 <<endl;
  file.close();
}
