...
/*-------------------------------------------------------------------
  ...
  void Analysis::Missing_Mass_Plot() {
	...
	data_tree_in->Draw("CTime_epCoinTime_ROC1>>all",  all_coin_cut, "goff");
	data_tree_in->Draw("CTime_epCoinTime_ROC1>>real", real_coin_cut, "goff");
	data_tree_in->Draw("CTime_epCoinTime_ROC1>>rand", rand_coin_cut, "goff");
