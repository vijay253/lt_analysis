...
TString Dummy_Name(int num_itt) {
	...
	if (int(kin_setting.thpqset[num_itt]*1000) == 0) {
	  ...
	  dir_str.Form("yields.%i_%i_0000.dummy", int(round(kin_setting.Q2set[num_itt]*10)), int(round(kin_setting.epsset[num_itt]*100)));	
...
TString Target_Name(int num_itt) {
	...
	if (int(kin_setting.thpqset[num_itt]*1000) == 0) {
	  ...
	  dir_str.Form("yields.%i_%i_0000.target", int(round(kin_setting.Q2set[num_itt]*10)), int(round(kin_setting.epsset[num_itt]*100)));	
...
TString List_Name(int num_itt) {
	...
	if (int(round(kin_setting.Q2set[num_itt]*10)) >= 10)
	  {
	    dir_str.Form("%i_%i", int(round(kin_setting.Q2set[num_itt]*10)), int(round(kin_setting.epsset[num_itt]*100)));
	  }else{
	  dir_str.Form("0%i_%i", int(round(kin_setting.Q2set[num_itt]*10)), int(round(kin_setting.epsset[num_itt]*100)));
	}
...
int Return_Setting_dummy(int list_itt, int run_itt, int set_itt) {
	...
	} else 	if (int(eff_setting_dummy[set_itt].thpqset[run_itt]*1000) > 0) {
...
//  	cout << "2222222222 " << endl;
	...
	} else 	if (int(eff_setting_target[set_itt].thpqset[run_itt]*1000) > 0) {
...
int Return_Setting(int list_itt, int run_itt, int set_itt) {
	...
	} else 	if (int(eff_setting[set_itt].thpqset[run_itt]*1000) > 0) {
