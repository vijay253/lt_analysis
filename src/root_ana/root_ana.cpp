...
TString List_Name(int num_itt) {
	...
	if (int(round(kin_setting.Q2set[num_itt]*10)) >= 10)
	  {
	    if (int(kin_setting.epsset[num_itt]*100) >= 10)
	      {
		dir_str.Form("%i_%i", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100));		
	      }else{
	      dir_str.Form("%i_0%i", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100));	
	    }
	  }else{
	    if (int(kin_setting.epsset[num_itt]*100) >= 10)
	      {
		dir_str.Form("0%i_%i", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100));		
	      ...
	      dir_str.Form("0%i_0%i", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100));	
	    }
	}
