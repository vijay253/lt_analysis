...
TString Dummy_Name(int num_itt) {
	...
	if (int(kin_setting.thpqset[num_itt]*1000) == 0) {
		...
		dir_str.Form("yields.%i_%i_0000.dummy", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100)*100);	

	} else {

		dir_str.Form("yields.%i_%i_%i.dummy", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100)*100, int(kin_setting.thpqset[num_itt]*1000));
...
TString Target_Name(int num_itt) {
	...
	if (int(kin_setting.thpqset[num_itt]*1000) == 0) {
		...
		dir_str.Form("yields.%i_%i_0000.target", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100)*100);	

	} else {

		dir_str.Form("yields.%i_%i_%i.target", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100)*100, int(kin_setting.thpqset[num_itt]*1000));	
...
TString List_Name(int num_itt) {
	...
	if (int(round(kin_setting.Q2set[num_itt]*10)) >= 10)
	  {
	    dir_str.Form("%i_%i", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100)*100);
	  }else{
	  dir_str.Form("0%i_%i", int(round(kin_setting.Q2set[num_itt]*10)), int(kin_setting.epsset[num_itt]*100)*100);
	}
