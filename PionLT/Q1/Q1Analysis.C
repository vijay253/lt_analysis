...
void Q1Analysis()
{
  ...
  if(Hostname.Contains("farm")){
    ...
    */  
    ...
    //    OutPath =  "/cache/hallc/kaonlt/vijay/Analysis/Q1";
    //OutPath =  "/u/home/vijay/LTsepscripts/Analysis/Q1/yield";

    //Changed to cache on Aug 29, 2025
    //    ROOTfilePath = "/cache/hallc/kaonlt/vijay/Analysis/Q1";
    ROOTfilePath = "/volatile/hallc/c-kaonlt/vijay/Analysis/Q1";
    //    OutPath =  "/cache/hallc/kaonlt/vijay/Analysis/Q1";
    OutPath =  "/u/home/vijay/LTsepscripts/Analysis/Q1/yield";
  ...
  //For systematics unc. studies
  //Double v = actual_variable * (1 +- 0.10);  // This is for 10% variation
  //Double_t SIMC_Yptar_Low_P   = -0.04 * (1 - 0.10);
  //Double_t SIMC_Yptar_High_P  =  0.04 * (1 - 0.10);
  ...
  Double_t epsilondC;TBRANCHDC->SetBranchAddress("epsilon", &epsilonC);
  Double_t  P_gtr_dpdC;TBRANCHDC->SetBranchAddress("ssdelta", &P_gtr_dpdC);
  Double_t  P_gtr_xptardC;TBRANCHDC->SetBranchAddress("ssxptar", &P_gtr_xptardC);
  Double_t  P_gtr_yptardC;TBRANCHDC->SetBranchAddress("ssyptar", &P_gtr_yptardC);
  Double_t  H_gtr_dpd;TBRANCHDC->SetBranchAddress("hsdelta", &H_gtr_dpd);  
  Double_t  H_gtr_xptardC;TBRANCHDC->SetBranchAddress("hsxptar", &H_gtr_xptardC);
  Double_t  H_gtr_yptardC;TBRANCHDC->SetBranchAddress("hsyptar", &H_gtr_yptardC);
  ...
  //Dummy
  Double_t  P_gtr_dpdL1;TBRANCHDL1->SetBranchAddress("ssdelta", &P_gtr_dpdL1);
  Double_t  P_gtr_xptardL1;TBRANCHDL1->SetBranchAddress("ssxptar", &P_gtr_xptardL1);
  Double_t  P_gtr_yptardL1;TBRANCHDL1->SetBranchAddress("ssyptar", &P_gtr_yptardL1);

  Double_t  H_gtr_dpdL1;TBRANCHDL1->SetBranchAddress("hsdelta", &H_gtr_dpdL1);
  Double_t  H_gtr_xptardL1;TBRANCHDL1->SetBranchAddress("hsxptar", &H_gtr_xptardL1);
  Double_t  H_gtr_yptardL1;TBRANCHDL1->SetBranchAddress("hsyptar", &H_gtr_yptardL1);
  
  Double_t WL1;TBRANCHL1->SetBranchAddress("W", &WL1);
  Double_t Q2L1;TBRANCHL1->SetBranchAddress("Q2", &Q2L1);
  Double_t epsilonL1;TBRANCHL1->SetBranchAddress("epsilon", &epsilonL1);

  //dummy
  Double_t WdL1;TBRANCHDL1->SetBranchAddress("W", &WdL1);
  Double_t Q2dL1;TBRANCHDL1->SetBranchAddress("Q2", &Q2dL1);
  Double_t epsilondL1;TBRANCHDL1->SetBranchAddress("epsilon", &epsilondL1);
  ...
  //Dummy
  Double_t  P_gtr_dpdL2;TBRANCHDL2->SetBranchAddress("ssdelta", &P_gtr_dpdL2);
  Double_t  P_gtr_xptardL2;TBRANCHDL2->SetBranchAddress("ssxptar", &P_gtr_xptardL2);
  Double_t  P_gtr_yptardL2;TBRANCHDL2->SetBranchAddress("ssyptar", &P_gtr_yptardL2);

  Double_t  H_gtr_dpdL2;TBRANCHDL2->SetBranchAddress("hsdelta", &H_gtr_dpdL2);
  Double_t  H_gtr_xptardL2;TBRANCHDL2->SetBranchAddress("hsxptar", &H_gtr_xptardL2);
  Double_t  H_gtr_yptardL2;TBRANCHDL2->SetBranchAddress("hsyptar", &H_gtr_yptardL2);

  Double_t WL2;TBRANCHL2->SetBranchAddress("W", &WL2);
  Double_t Q2L2;TBRANCHL2->SetBranchAddress("Q2", &Q2L2);
  Double_t epsilonL2;TBRANCHL2->SetBranchAddress("epsilon", &epsilonL2);

  //dummy
  Double_t WdL2;TBRANCHDL2->SetBranchAddress("W", &WdL2);
  Double_t Q2dL2;TBRANCHDL2->SetBranchAddress("Q2", &Q2dL2);
  Double_t epsilondL2;TBRANCHDL2->SetBranchAddress("epsilon", &epsilondL2);
 ...
 //*************************
  //plot added on May 1, 2026
  Double_t Nobin   = 150;
  Double_t xQ2minC = 0.25;
  Double_t xQ2maxC = 0.55;
  Double_t xWminC = 2.14;
  Double_t xWmaxC = 2.26;
  Double_t xepminC = 0.24;
  Double_t xepmaxC = 0.32;
  //Thesis Plots
  //Center
  TH1D *hthQ2C  = new TH1D("hthQ2C"," ; Q^{2} (GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWC   = new TH1D("hthWC"," ;W (GeV); Yield (events/mC)", Nobin, xWminC, xWmaxC);
  TH1D *hthepC   = new TH1D("hthepC"," ;epsilon; Yield (events/mC)", Nobin,  xepminC, xepmaxC);      
  //Random
  TH1D *hthQ2CR  = new TH1D("hthQ2CR"," ; Q^{2} (GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWCR   = new TH1D("hthWCR"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepCR   = new TH1D("hthepCR"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      

  //Dummy
  TH1D *hthQ2dC  = new TH1D("hthQ2dC"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWdC   = new TH1D("hthWdC"," ;W (GeV); Yield (events/mC)", Nobin, xWminC, xWmaxC);
  TH1D *hthepdC   = new TH1D("hthepdC"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      
  //Random
  TH1D *hthQ2dCR  = new TH1D("hthQ2dCR"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWdCR   = new TH1D("hthWdCR"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepdCR   = new TH1D("hthepdCR"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      
 
  //SIMC
  TH1D *hthQ2SC  = new TH1D("hthQ2SC"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWSC   = new TH1D("hthWSC"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepSC   = new TH1D("hthepSC"," ;epsilon; Yield (events/mC)", Nobin,xepminC, xepmaxC);      

  //Left1
  TH1D *hthQ2L1  = new TH1D("hthQ2L1"," ; Q^{2} (GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWL1   = new TH1D("hthWL1"," ;W (GeV); Yield (events/mC)", Nobin, xWminC, xWmaxC);
  TH1D *hthepL1   = new TH1D("hthepL1"," ;epsilon; Yield (events/mC)", Nobin,  xepminC, xepmaxC);      
  //Random
  TH1D *hthQ2L1R  = new TH1D("hthQ2L1R"," ; Q^{2} (GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWL1R   = new TH1D("hthWL1R"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepL1R   = new TH1D("hthepL1R"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      

  //Dummy
  TH1D *hthQ2dL1  = new TH1D("hthQ2dL1"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWdL1   = new TH1D("hthWdL1"," ;W (GeV); Yield (events/mC)", Nobin, xWminC, xWmaxC);
  TH1D *hthepdL1   = new TH1D("hthepdL1"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      
  //Random
  TH1D *hthQ2dL1R  = new TH1D("hthQ2dL1R"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWdL1R   = new TH1D("hthWdL1R"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepdL1R   = new TH1D("hthepdL1R"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      
 
  //SIMC
  TH1D *hthQ2SL1  = new TH1D("hthQ2SL1"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWSL1   = new TH1D("hthWSL1"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepSL1   = new TH1D("hthepSL1"," ;epsilon; Yield (events/mC)", Nobin,xepminC, xepmaxC);      

  //Left2

    //Center
  TH1D *hthQ2L2  = new TH1D("hthQ2L2"," ; Q^{2} (GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWL2   = new TH1D("hthWL2"," ;W (GeV); Yield (events/mC)", Nobin, xWminC, xWmaxC);
  TH1D *hthepL2   = new TH1D("hthepL2"," ;epsilon; Yield (events/mC)", Nobin,  xepminC, xepmaxC);      
  //Random
  TH1D *hthQ2L2R  = new TH1D("hthQ2L2R"," ; Q^{2} (GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWL2R   = new TH1D("hthWL2R"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepL2R   = new TH1D("hthepL2R"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      

  //Dummy
  TH1D *hthQ2dL2  = new TH1D("hthQ2dL2"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWdL2   = new TH1D("hthWdL2"," ;W (GeV); Yield (events/mC)", Nobin, xWminC, xWmaxC);
  TH1D *hthepdL2   = new TH1D("hthepdL2"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      
  //Random
  TH1D *hthQ2dL2R  = new TH1D("hthQ2dL2R"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWdL2R   = new TH1D("hthWdL2R"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepdL2R   = new TH1D("hthepdL2R"," ;epsilon; Yield (events/mC)", Nobin, xepminC, xepmaxC);      
 
  //SIMC
  TH1D *hthQ2SL2  = new TH1D("hthQ2SL2"," ; Q^{2}(GeV^{2}); Yield (events/mC)", Nobin, xQ2minC,xQ2maxC);      
  TH1D *hthWSL2   = new TH1D("hthWSL2"," ;W (GeV); Yield (events/mC)", Nobin,xWminC,xWmaxC);
  TH1D *hthepSL2   = new TH1D("hthepSL2"," ;epsilon; Yield (events/mC)", Nobin,xepminC, xepmaxC);      
 ...
 //*************************
  ...
  TH2D *hQ2WC  = new TH2D("hQ2WC","; ; ", 300, 0.25, 0.55, 300, 2.16, 2.23);      
  TH2D *hQ2WC1  = new TH2D("hQ2WC1","; ; ", 300, 0.25, 0.55, 300, 2.16, 2.23);      

  TH2D *hQ2WCR  = new TH2D("hQ2WCR","; ; ", 300, 0.25, 0.55, 300, 2.16, 2.23);      
  TH2D *hQ2WC1R  = new TH2D("hQ2WC1R","; ; ", 300, 0.25, 0.55, 300, 2.16, 2.23);      
  //SIMC
  TH2D *hQ2WSC  = new TH2D("hQ2WSC","; ; ", 300, 0.25, 0.55, 300, 2.16, 2.23);      
  TH2D *hQ2WSC1  = new TH2D("hQ2WSC1","; ; ", 300, 0.25, 0.55, 300, 2.16, 2.23);      
  ...
  Double_t bins[] = {-0.01, 0.00595, 0.0113167, 0.0156167, 0.02515, 0.03455, 0.0406833, 0.05465, 0.060, 0.0741167, 0.1};
  Double_t phibins[] = {-22.5, 0.0, 22.5, 45.0, 67.5, 90.0, 112.5, 135.0, 157.5, 180.0, 202.5, 225.0, 247.5, 270.0, 292.5, 315.0, 337.5, 360.0, 382.5};
  ...
  hYSL1->Sumw2();
  hYSL2->Sumw2();
  TH2D *hYSCerr   = new TH2D("hYSCerr"," Yield SIMC C;t-Bin; Phi-Bin ", 10, bins, 18, -22.5, 382.5);      
  TH2D *hYSL1err   = new TH2D("hYSL1err"," Yield SIMC L1;t-Bin; Phi-Bin ", 10 , bins, 18, -22.5, 382.5);      
  TH2D *hYSL2err   = new TH2D("hYSL2err"," Yield SIMC L2;t-Bin; Phi-Bin ", 10, bins, 18, -22.5, 382.5);      
  
  //SIMC and Data HISTOGRAMS
  //CENTER
  TH1D *hphC  = new TH1D("hphC","ph_q; ph_q;",50, -10, 370);      
  TH1D *hphCR  = new TH1D("hphCR","ph_q; ph_q;",  50, -10, 370);      
  TH1D *hphdC  = new TH1D("hphdC","ph_q; ph_q;",50, -10, 370);      
  TH1D *hphdCR  = new TH1D("hphdCR","ph_q; ph_q;",  50, -10, 370);      
  ...
  TH1D *H_ssdelta_DdC  = new TH1D("H_ssdelta_DdC","SHMS delta; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DdC  = new TH1D("H_ssxptar_DdC","SHMS xptar; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DdC  = new TH1D("H_ssyptar_DdC","SHMS yptar; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DdCR  = new TH1D("H_ssdelta_DdCR","SHMS delta; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DdCR  = new TH1D("H_ssxptar_DdCR","SHMS xptar; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DdCR  = new TH1D("H_ssyptar_DdCR","SHMS yptar; ssyptar;", 50, -0.04, 0.04);
  ...
  TH1D *H_hsxptar_DdC  = new TH1D("H_hsxptar_DdC","HMS xptar; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DdC  = new TH1D("H_hsyptar_DdC","HMS yptar; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DummyCR  = new TH1D("H_hsdelta_DummyCR","HMS Delta; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DdCR  = new TH1D("H_hsxptar_DdCR","HMS xptar; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DdCR  = new TH1D("H_hsyptar_DdCR","HMS yptar; hsyptar;", 50, -0.05, 0.05);
  ...
  TH1D *hphdL1  = new TH1D("hphdL1","ph_q; ph_q;",50, -10, 370);      
  TH1D *hphdL1R  = new TH1D("hphdL1R","ph_q; ph_q;",  50, -10, 370);      
  ...
  //Dummy
  TH1D *H_ssdelta_DdL1  = new TH1D("H_ssdelta_DdL1","SHMS delta; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DdL1  = new TH1D("H_ssxptar_DdL1","SHMS xptar; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DdL1  = new TH1D("H_ssyptar_DdL1","SHMS yptar; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DdL1R  = new TH1D("H_ssdelta_DdL1R","SHMS delta; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DdL1R  = new TH1D("H_ssxptar_DdL1R","SHMS xptar; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DdL1R  = new TH1D("H_ssyptar_DdL1R","SHMS yptar; ssyptar;", 50, -0.04, 0.04);
  ...
  //Dummy
  TH1D *H_hsdelta_DummyL1  = new TH1D("H_hsdelta_DummyL1","HMS Delta; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DdL1  = new TH1D("H_hsxptar_DdL1","HMS xptar; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DdL1  = new TH1D("H_hsyptar_DdL1","HMS yptar; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DummyL1R  = new TH1D("H_hsdelta_DummyL1R","HMS Delta; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DdL1R  = new TH1D("H_hsxptar_DdL1R","HMS xptar; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DdL1R  = new TH1D("H_hsyptar_DdL1R","HMS yptar; hsyptar;", 50, -0.05, 0.05);
  ...
  TH1D *hphdL2  = new TH1D("hphdL2","ph_q; ph_q;",50, -10, 370);      
  TH1D *hphdL2R  = new TH1D("hphdL2R","ph_q; ph_q;",  50, -10, 370);      
  ...
  //Dummy
  TH1D *H_ssdelta_DdL2  = new TH1D("H_ssdelta_DdL2","SHMS delta; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DdL2  = new TH1D("H_ssxptar_DdL2","SHMS xptar; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DdL2  = new TH1D("H_ssyptar_DdL2","SHMS yptar; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DdL2R  = new TH1D("H_ssdelta_DdL2R","SHMS delta; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DdL2R  = new TH1D("H_ssxptar_DdL2R","SHMS xptar; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DdL2R  = new TH1D("H_ssyptar_DdL2R","SHMS yptar; ssyptar;", 50, -0.04, 0.04);
  ...
  //Dummy
  TH1D *H_hsdelta_DummyL2  = new TH1D("H_hsdelta_DummyL2","HMS Delta; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DdL2  = new TH1D("H_hsxptar_DdL2","HMS xptar; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DdL2  = new TH1D("H_hsyptar_DdL2","HMS yptar; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DummyL2R  = new TH1D("H_hsdelta_DummyL2R","HMS Delta; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DdL2R  = new TH1D("H_hsxptar_DdL2R","HMS xptar; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DdL2R  = new TH1D("H_hsyptar_DdL2R","HMS yptar; hsyptar;", 50, -0.05, 0.05);
  ...
  //Sep 01, 2025
  int Bin_Sep1_25 = 200;
  Double_t X1_Sep1_25 = 0.90;
  Double_t X2_Sep1_25 = 1.0;
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_C_i%d_j%d", i, j);
	  histC[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Random
    TH1D* histCR[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_CR_i%d_j%d", i, j);
	  histCR[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Dummy
  TH1D* histdC[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_dC_i%d_j%d", i, j);
	  histdC[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Dummy Random
  TH1D* histdCR[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_dCR_i%d_j%d", i, j);
	  histdCR[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //SIMC
  TH1D* histSC[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_SC_i%d_j%d", i, j);
	  histSC[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_L1_i%d_j%d", i, j);
	  histL1[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Random
    TH1D* histL1R[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_L1R_i%d_j%d", i, j);
	  histL1R[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Dummy
  TH1D* histdL1[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_dL1_i%d_j%d", i, j);
	  histdL1[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Dummy Random
  TH1D* histdL1R[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_dL1R_i%d_j%d", i, j);
	  histdL1R[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //SIMC
  TH1D* histSL1[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_SL1_i%d_j%d", i, j);
	  histSL1[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_L2_i%d_j%d", i, j);
	  histL2[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Random
    TH1D* histL2R[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_L2R_i%d_j%d", i, j);
	  histL2R[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Dummy
  TH1D* histdL2[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_dL2_i%d_j%d", i, j);
	  histdL2[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //Dummy Random
  TH1D* histdL2R[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_dL2R_i%d_j%d", i, j);
	  histdL2R[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  //SIMC
  TH1D* histSL2[8][16];
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  TString histName = Form("h_SL2_i%d_j%d", i, j);
	  histSL2[i][j] = new TH1D(histName, "MMpi", Bin_Sep1_25, X1_Sep1_25, X2_Sep1_25);
	}
    }
  ...
  */
  Dcut->SetPoint(0,0.366065,2.18346);Dcut->SetPoint(1,0.314438,2.224);  
  Dcut->SetPoint(2,0.37657,2.20992); Dcut->SetPoint(3,0.440025,2.16656);
  Dcut->SetPoint(4,0.366065,2.18346); 

  //////////////////////////////
  Double_t MMPICUTL = 0.91; 
  Double_t MMPICUTH = 0.98; 
  //  Double_t COINCUTDEP = 0.1;             // 10% Wider
  //Double_t COINCUTDEP = -0.1;               //  10% Narrower
  Double_t COINCUTDEP = 0.0;           //   No changes
  /////////////////////////////
  ...
  */
  //Garth Number, April 06, 26
  Double_t tOffsetC  = 0.00111;
  Double_t tOffsetL1  = 0.0014;
  Double_t tOffsetL2  = 0.00133;  
  /*
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHC; i++)
	...
	htcoinC->Fill(tcoinC-TimmingOffset);
      ...
      Double_t CoinPionC = tcoinC-TimmingOffset>=-1.0-COINCUTDEP && tcoinC-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPionC && MMpiC && DiamondC)
	{
	  ...
	  hYC->Fill(-tC+tOffsetC, std::fmod(ph_qC * 180.0 / TMath::Pi() + 360.0, 360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tC+tOffsetC) >= bins[i+1] && (-tC+tOffsetC) <= bins[i+2]) && ((ph_qC*57.2958 + 180) >= phibins[j+1] && (ph_qC*57.2958 + 180) <= phibins[j+2]))
		    {
		      histC[i][j]->Fill(mmC+MMpiOffsetC);
		    }		  		  
		}
	    }     
      ...
      if(CoinPionCR && MMpiC && DiamondC)
	{
	  ...
	  hQ2WCR->Fill(Q2C, WC);
	  hYCR->Fill(-tC+tOffsetC, std::fmod(ph_qC * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tC+tOffsetC) >= bins[i+1] && (-tC+tOffsetC) <= bins[i+2]) && ((ph_qC*57.2958 + 180) >= phibins[j+1] && (ph_qC*57.2958 + 180) <= phibins[j+2]))
		    {
		      histCR[i][j]->Fill(mmC+MMpiOffsetC);
		    }		  		  
		}
	    }     
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHDC; i++)
    {
      ...
      Double_t CoinPiondC = tcoindC-TimmingOffset>=-1.0-COINCUTDEP && tcoindC-TimmingOffset <= 1.0+COINCUTDEP;      
	...
	{	  
	  hYdC->Fill(-tdC+tOffsetC, std::fmod(ph_qdC * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYdC->Fill(-tdC, mmdC+MMpiOffsetC);
	  hthtdC->Fill(-tdC+tOffsetC); 
	  hphdC->Fill(std::fmod(ph_qdC * 180.0 / TMath::Pi() + 360.0,360.0));
	  hthQ2dC->Fill(Q2dC);      
	  hthWdC->Fill(WdC);
	  hthepdC->Fill(epsilondC);      
	  H_ssdelta_DdC->Fill(P_gtr_dpdC);
	  H_ssxptar_DdC->Fill(P_gtr_xptardC);
	  H_ssyptar_DdC->Fill(P_gtr_yptardC);

	  H_hsdelta_DummyC->Fill(H_gtr_dpd);
	  H_hsxptar_DdC->Fill(H_gtr_xptardC);
	  H_hsyptar_DdC->Fill(H_gtr_yptardC);

	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tdC+tOffsetC) >= bins[i+1] && (-tdC+tOffsetC) <= bins[i+2]) && ((ph_qdC*57.2958 + 180) >= phibins[j+1] && (ph_qdC*57.2958 + 180) <= phibins[j+2]))
		    {
		      histdC[i][j]->Fill(mmdC+MMpiOffsetC);
		    }		  		  
		}
	    }     
	...
	{
	  hYdCR->Fill(-tdC+tOffsetC, std::fmod(ph_qdC * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYdCR->Fill(-tdC, mmdC+MMpiOffsetC);
	  hthtdCR->Fill(-tdC+tOffsetC); 
	  H_hsdelta_DummyCR->Fill(H_gtr_dpd);
	  hphdCR->Fill(std::fmod(ph_qdC * 180.0 / TMath::Pi() + 360.0,360.0));
	  hthQ2dCR->Fill(Q2dC);      
	  hthWdCR->Fill(WdC);
	  hthepdCR->Fill(epsilondC);      
	  H_ssdelta_DdCR->Fill(P_gtr_dpdC);
	  H_ssxptar_DdCR->Fill(P_gtr_xptardC);
	  H_ssyptar_DdCR->Fill(P_gtr_yptardC);

	  H_hsxptar_DdCR->Fill(H_gtr_xptardC);
	  H_hsyptar_DdCR->Fill(H_gtr_yptardC);
	  ...
	  for(int i = 0; i < 8; i++)
	      ...
	      for(int j =0; j <16; j++)
		{
		  if(((-tdC+tOffsetC) >= bins[i+1] && (-tdC+tOffsetC) <= bins[i+2]) && ((ph_qdC*57.2958 + 180) >= phibins[j+1] && (ph_qdC*57.2958 + 180) <= phibins[j+2]))
		    {
		      histdCR[i][j]->Fill(mmdC+MMpiOffsetC);
		    }		  		  
		}
	    }     
    ...
    //SIMC CENTER
   Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q1_center.hist");
   Double_t fact = normfac/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCC; i++)

    {
      ...
      // Double_t fact = 9718400.0/400000.0;
      // Double_t fact = 9765080.0/400000.0;
      //    Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q1_center.hist");
      // Double_t fact = normfac/400000.0;
      //RadiativeStudy
      // Double_t fact = 8219010.0/400000.0;
      ...
      if(CUTSIMCC)
	{
	  ...
	  hYSCerr->Fill(t_simc, phipq*57.2958);
	  ...
	  hthWSC->Fill(W_simc,fact*Weight);
	  hthepSC->Fill(epsilon_simc, fact*Weight);      
	  ...
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if((t_simc >= bins[i+1] && t_simc <= bins[i+2]) && (phipq*57.2958 >= phibins[j+1] && phipq*57.2958 <= phibins[j+2]))
		    {
		      histSC[i][j]->Fill(missmass, fact*Weight);
		    }		  		  
		}
	    }     
	}    
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHL1; i++)
	...
	htcoinL1->Fill(tcoinL1-TimmingOffset);
      ...
      Double_t CoinPionL1 = tcoinL1-TimmingOffset>=-1.0-COINCUTDEP && tcoinL1-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  hthQ2L1->Fill(Q2L1);      
	  hthWL1->Fill(WL1);
	  hthepL1->Fill(epsilonL1);      

	  hthtL1->Fill(-tL1+tOffsetL1); 
	  htL1->Fill(-tL1);
 	  htInL1->Fill(-tL1);
	  ...
	  hYL1->Fill(-tL1+tOffsetL1, std::fmod(ph_qL1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tL1+tOffsetL1) >= bins[i+1] && (-tL1+tOffsetL1) <= bins[i+2]) && ((ph_qL1*57.2958 + 180) >= phibins[j+1] && (ph_qL1*57.2958 + 180) <= phibins[j+2]))
		    {
		      histL1[i][j]->Fill(mmL1+MMpiOffsetL1);
		    }		  		  
		}
	    }     
      ...
      if(CoinPionL1R && MMpiL1 && DiamondL1)		
	{
	  ...
	  hthQ2L1R->Fill(Q2L1);      
	  hthWL1R->Fill(WL1);
	  hthepL1R->Fill(epsilonL1);      

	  hthtL1R->Fill(-tL1+tOffsetL1); 
	  htL1R->Fill(-tL1);
 	  htInL1R->Fill(-tL1);
	  ...
	  hYL1R->Fill(-tL1+tOffsetL1, std::fmod(ph_qL1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tL1+tOffsetL1) >= bins[i+1] && (-tL1+tOffsetL1) <= bins[i+2]) && ((ph_qL1*57.2958 + 180) >= phibins[j+1] && (ph_qL1*57.2958 + 180) <= phibins[j+2]))
		    {
		      histL1R[i][j]->Fill(mmL1+MMpiOffsetL1);
		    }		  		  
		}
	    }     
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHDL1; i++)
    {
      ...
      Double_t CoinPiondL1 = tcoindL1-TimmingOffset>=-1.0-COINCUTDEP && tcoindL1-TimmingOffset <= 1.0+COINCUTDEP;      
	...
	{
	  H_ssdelta_DdL1->Fill(P_gtr_dpdL1);
	  H_ssxptar_DdL1->Fill(P_gtr_xptardL1);
	  H_ssyptar_DdL1->Fill(P_gtr_yptardL1);

	  H_hsdelta_DummyL1->Fill(H_gtr_dpdL1);
	  H_hsxptar_DdL1->Fill(H_gtr_xptardL1);
	  H_hsyptar_DdL1->Fill(H_gtr_yptardL1);

	  hthQ2dL1->Fill(Q2dL1);      
	  hthWdL1->Fill(WdL1);
	  hthepdL1->Fill(epsilondL1);      
	  hphdL1->Fill(std::fmod(ph_qdL1 * 180.0 / TMath::Pi() + 360.0,360.0));	  

	  hYdL1->Fill(-tdL1+tOffsetL1, std::fmod(ph_qdL1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tdL1+tOffsetL1) >= bins[i+1] && (-tdL1+tOffsetL1) <= bins[i+2]) && ((ph_qdL1*57.2958 + 180) >= phibins[j+1] && (ph_qdL1*57.2958 + 180) <= phibins[j+2]))
		    {
		      histdL1[i][j]->Fill(mmdL1+MMpiOffsetL1);
		    }		  		  
		}
	    }     
	...
	{
	  H_ssdelta_DdL1R->Fill(P_gtr_dpdL1);
	  H_ssxptar_DdL1R->Fill(P_gtr_xptardL1);
	  H_ssyptar_DdL1R->Fill(P_gtr_yptardL1);

	  H_hsdelta_DummyL1R->Fill(H_gtr_dpdL1);
	  H_hsxptar_DdL1R->Fill(H_gtr_xptardL1);
	  H_hsyptar_DdL1R->Fill(H_gtr_yptardL1);

	  hthQ2dL1R->Fill(Q2dL1);      
	  hthWdL1R->Fill(WdL1);
	  hthepdL1R->Fill(epsilondL1);      
	  hphdL1R->Fill(std::fmod(ph_qdL1 * 180.0 / TMath::Pi() + 360.0,360.0));	  

	  hYdL1R->Fill(-tdL1+tOffsetL1, std::fmod(ph_qdL1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tdL1+tOffsetL1) >= bins[i+1] && (-tdL1+tOffsetL1) <= bins[i+2]) && ((ph_qdL1*57.2958 + 180) >= phibins[j+1] && (ph_qdL1*57.2958 + 180) <= phibins[j+2]))
		    {
		      histdL1R[i][j]->Fill(mmdL1+MMpiOffsetL1);
		    }		  		  
		}
	    }     
  ...
  //SIMC LEFT1
  Double_t normfacL1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q1_left1.hist");
  Double_t factL1 = normfacL1/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCL1; i++)
    
    {
      ...
      //      Double_t factL1 =  9910160/400000.0;
      // Double_t factL1 =  10634200/400000.0;
      // Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q1_left1.hist");
      // Double_t factL1 = normfac/400000.0;

      // Double_t factL1 = 10728400/400000.0;
      //RadiativeStudy
      //Double_t factL1 = 7725110.0/400000.0;
      ...
      if(CUTSIMCL1)
	{
	  ...
	  hYSL1err->Fill(t_simcL1, phipqL1*57.2958);
	  ...
	  hthQ2SL1->Fill(Q2_simcL1,factL1*WeightL1);      
	  hthWSL1->Fill(W_simcL1,factL1*WeightL1);
	  hthepSL1->Fill(epsilon_simcL1, factL1*WeightL1);      
	  ...
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if((t_simcL1 >= bins[i+1] && t_simcL1 <= bins[i+2]) && (phipqL1*57.2958 >= phibins[j+1] && phipqL1*57.2958 <= phibins[j+2]))
		    {
		      histSL1[i][j]->Fill(missmassL1, factL1*WeightL1);
		    }		  		  
		}
	    }     
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHL2; i++)
	...
	htcoinL2->Fill(tcoinL2-TimmingOffset);
      ...
      Double_t CoinPionL2 = tcoinL2-TimmingOffset>=-1.0-COINCUTDEP && tcoinL2-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPionL2 && MMpiL2 && DiamondL2)
	{
	  ...
	  hYL2->Fill(-tL2+tOffsetL2, std::fmod(ph_qL2 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tL2+tOffsetL2) >= bins[i+1] && (-tL2+tOffsetL2) <= bins[i+2]) && ((ph_qL2*57.2958 + 180) >= phibins[j+1] && (ph_qL2*57.2958 + 180) <= phibins[j+2]))
		    {
		      histL2[i][j]->Fill(mmL2+MMpiOffsetL2);
		    }		  		  
		}
	    }     
      ...
      if(CoinPionL2R && MMpiL2 && DiamondL2)
	{
	  ...
	  hYL2R->Fill(-tL2+tOffsetL2, std::fmod(ph_qL2 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tL2+tOffsetL2) >= bins[i+1] && (-tL2+tOffsetL2) <= bins[i+2]) && ((ph_qL2*57.2958 + 180) >= phibins[j+1] && (ph_qL2*57.2958 + 180) <= phibins[j+2]))
		    {
		      histL2R[i][j]->Fill(mmL2+MMpiOffsetL2);
		    }		  		  
		}
	    }     
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHDL2; i++)
    {
      ...
      Double_t CoinPiondL2 = tcoindL2-TimmingOffset>=-1.0-COINCUTDEP && tcoindL2-TimmingOffset <= 1.0+COINCUTDEP;      
	...
	{
	  H_ssdelta_DdL2->Fill(P_gtr_dpdL2);
	  H_ssxptar_DdL2->Fill(P_gtr_xptardL2);
	  H_ssyptar_DdL2->Fill(P_gtr_yptardL2);

	  H_hsdelta_DummyL2->Fill(H_gtr_dpdL2);
	  H_hsxptar_DdL2->Fill(H_gtr_xptardL2);
	  H_hsyptar_DdL2->Fill(H_gtr_yptardL2);

	  hthQ2dL2->Fill(Q2dL2);      
	  hthWdL2->Fill(WdL2);
	  hthepdL2->Fill(epsilondL2);      
	  hphdL2->Fill(std::fmod(ph_qdL2 * 180.0 / TMath::Pi() + 360.0,360.0));	  

	  hYdL2->Fill(-tdL2+tOffsetL2, std::fmod(ph_qdL2 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tdL2+tOffsetL2) >= bins[i+1] && (-tdL2+tOffsetL2) <= bins[i+2]) && ((ph_qdL2*57.2958 + 180) >= phibins[j+1] && (ph_qdL2*57.2958 + 180) <= phibins[j+2]))
		    {
		      histdL2[i][j]->Fill(mmdL2+MMpiOffsetL2);
		    }		  		  
		}
	    }     
	...
	{
	  H_ssdelta_DdL2R->Fill(P_gtr_dpdL2);
	  H_ssxptar_DdL2R->Fill(P_gtr_xptardL2);
	  H_ssyptar_DdL2R->Fill(P_gtr_yptardL2);

	  H_hsdelta_DummyL2R->Fill(H_gtr_dpdL2);
	  H_hsxptar_DdL2R->Fill(H_gtr_xptardL2);
	  H_hsyptar_DdL2R->Fill(H_gtr_yptardL2);

	  hthQ2dL2R->Fill(Q2dL2);      
	  hthWdL2R->Fill(WdL2);
	  hthepdL2R->Fill(epsilondL2);
	  hphdL2R->Fill(std::fmod(ph_qdL2 * 180.0 / TMath::Pi() + 360.0,360.0));	  
	  
	  hYdL2R->Fill(-tdL2+tOffsetL2, std::fmod(ph_qdL2 * 180.0 / TMath::Pi() + 360.0,360.0));
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if(((-tdL2+tOffsetL2) >= bins[i+1] && (-tdL2+tOffsetL2) <= bins[i+2]) && ((ph_qdL2*57.2958 + 180) >= phibins[j+1] && (ph_qdL2*57.2958 + 180) <= phibins[j+2]))
		    {
		      histdL2R[i][j]->Fill(mmdL2+MMpiOffsetL2);
		    }		  		  
		}
	    }     	  
  ...
  //SIMC LEFT2
  Double_t normfacL2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q1_left2.hist");
  Double_t factL2 = normfacL2/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCL2; i++)
    
    {
      ...
      //      Double_t factL2 = 9614160/400000.0;
      // Double_t factL2 = 10769000/400000.0;
      // Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q1_left2.hist");
      // Double_t factL2 = normfac/400000.0;

      //      Double_t factL2 = 10829900/400000.0;
      //RadiativeStudy
      //Double_t factL2 = 7695470.0/400000.0;
	...
	
	{
	  ...
	  hYSL2err->Fill(t_simcL2, phipqL2*57.2958);
	  ...
	  hthQ2SL2->Fill(Q2_simcL2,factL2*WeightL2);      
	  hthWSL2->Fill(W_simcL2,factL2*WeightL2);
	  hthepSL2->Fill(epsilon_simcL2, factL2*WeightL2);
	  ...
	  for(int i = 0; i < 8; i++)
	    {
	      for(int j =0; j <16; j++)
		{
		  if((t_simcL2 >= bins[i+1] && t_simcL2 <= bins[i+2]) && (phipqL2*57.2958 >= phibins[j+1] && phipqL2*57.2958 <= phibins[j+2]))
		    {
		      histSL2[i][j]->Fill(missmassL2, factL2*WeightL2);
		    }		  		  
		}
	    }     
  ...
  //Dummy
  H_ssdelta_DdCR->Scale(RTSCALE);
  H_ssxptar_DdCR->Scale(RTSCALE);
  H_ssyptar_DdCR->Scale(RTSCALE);
  
  H_ssdelta_DL1R->Scale(RTSCALE);
  H_ssxptar_DL1R->Scale(RTSCALE);
  H_ssyptar_DL1R->Scale(RTSCALE);
  //Dummy 
  H_ssdelta_DdL1R->Scale(RTSCALE);
  H_ssxptar_DdL1R->Scale(RTSCALE);
  H_ssyptar_DdL1R->Scale(RTSCALE);
  
  H_ssdelta_DL2R->Scale(RTSCALE);
  H_ssxptar_DL2R->Scale(RTSCALE);
  H_ssyptar_DL2R->Scale(RTSCALE);
  //Dummy
  H_ssdelta_DdL2R->Scale(RTSCALE);
  H_ssxptar_DdL2R->Scale(RTSCALE);
  H_ssyptar_DdL2R->Scale(RTSCALE);
  //HMS
  ...
  H_hsxptar_DdCR->Scale(RTSCALE);
  H_hsyptar_DdCR->Scale(RTSCALE);
  
  H_hsdelta_DL1R->Scale(RTSCALE);
  H_hsxptar_DL1R->Scale(RTSCALE);
  H_hsyptar_DL1R->Scale(RTSCALE);
  //Dummy
  H_hsdelta_DummyL1R->Scale(RTSCALE);
  H_hsxptar_DdL1R->Scale(RTSCALE);
  H_hsyptar_DdL1R->Scale(RTSCALE);

  H_hsdelta_DL2R->Scale(RTSCALE);
  H_hsxptar_DL2R->Scale(RTSCALE);
  H_hsyptar_DL2R->Scale(RTSCALE);
  //Dummy
  H_hsdelta_DummyL2R->Scale(RTSCALE);
  H_hsxptar_DdL2R->Scale(RTSCALE);
  H_hsyptar_DdL2R->Scale(RTSCALE);
  
  //Data
  hthQ2CR->Scale(RTSCALE);      
  hthWCR->Scale(RTSCALE);
  hthepCR->Scale(RTSCALE);      
  hthQ2L1R->Scale(RTSCALE);      
  hthWL1R->Scale(RTSCALE);
  hthepL1R->Scale(RTSCALE);      
  hthQ2L2R->Scale(RTSCALE);      
  hthWL2R->Scale(RTSCALE);
  hthepL2R->Scale(RTSCALE);      
  //Dummy
  hthQ2dCR->Scale(RTSCALE);      
  hthWdCR->Scale(RTSCALE);
  hthepdCR->Scale(RTSCALE);      
  hthQ2dL1R->Scale(RTSCALE);      
  hthWdL1R->Scale(RTSCALE);
  hthepdL1R->Scale(RTSCALE);      
  hthQ2dL2R->Scale(RTSCALE);      
  hthWdL2R->Scale(RTSCALE);
  hthepdL2R->Scale(RTSCALE);      

  hphCR->Scale(RTSCALE);
  hphdCR->Scale(RTSCALE);
  hphL1R->Scale(RTSCALE);
  hphdL1R->Scale(RTSCALE);
  hphL2R->Scale(RTSCALE);
  hphdL2R->Scale(RTSCALE);
  hthCR->Scale(RTSCALE);
  ...
  //Effective charge 
  Double_t ECLEC   = 1.0/405.4366491177242;
  Double_t ECLECErr = 4.96947441060304;  
  Double_t ECLEDC  = 1.0/36.65011814744625;
  Double_t ECLEDCErr = 0.06376639812845264;  

  Double_t ECLEL1  = 1.0/554.4139777520979;
  Double_t ECLEL1Err = 1.4834962279581578;  
  Double_t ECLEDL1 = 1.0/30.88492883320679;
  Double_t ECLEDL1Err = 0.036576380796874544;  

  Double_t ECLEL2  = 1.0/679.984570407808;
  Double_t ECLEL2Err = 1.3313824902408349;  
  Double_t ECLEDL2 = 1.0/33.461650108902546;
  Double_t ECLEDL2Err = 0.04052544248680898;  
  ...
  //  MPiC->SetStats(0);
  TAxis *XmpileC = MPiC->GetXaxis();
  Double_t InmpileC = MPiC->Integral(XmpileC->FindBin(MMPICUTL), XmpileC->FindBin(MMPICUTH), "");
  TAxis *XmpiSleC = MPiSC->GetXaxis();
  Double_t InmpiSleC = MPiSC->Integral(XmpiSleC->FindBin(MMPICUTL), XmpiSleC->FindBin(MMPICUTH), "");
  Double_t SSleC = InmpileC/InmpiSleC; 
  MPiSC->Scale(SSleC);
  MPiSC->Draw("hist");
  MPiC->Draw("same");
  ...
  TAxis *XmpileL1 = MPiL1->GetXaxis();
  Double_t InmpileL1 = MPiL1->Integral(XmpileL1->FindBin(MMPICUTL), XmpileL1->FindBin(MMPICUTH), "");
  TAxis *XmpiSleL1 = MPiSL1->GetXaxis();
  Double_t InmpiSleL1 = MPiSL1->Integral(XmpiSleL1->FindBin(MMPICUTL), XmpiSleL1->FindBin(MMPICUTH), "");
  Double_t SSleL1 = InmpileL1/InmpiSleL1; 
  MPiSL1->Scale(SSleL1);
  MPiSL1->Draw("hist");
  //  MPiL1->SetStats(0);
  MPiL1->Draw("same");
  ...
  TAxis *XmpileL2 = MPiL2->GetXaxis();
  Double_t InmpileL2 = MPiL2->Integral(XmpileL2->FindBin(MMPICUTL), XmpileL2->FindBin(MMPICUTH), "");
  TAxis *XmpiSleL2 = MPiSL2->GetXaxis();
  Double_t InmpiSleL2 = MPiSL2->Integral(XmpiSleL2->FindBin(MMPICUTL), XmpiSleL2->FindBin(MMPICUTH), "");
  Double_t SSleL2 = InmpileL2/InmpiSleL2; 
  MPiSL2->Scale(SSleL2);
  MPiSL2->Draw("hist");
  //  MPiL2->SetStats(0);
  MPiL2->Draw("same");
 ...
 TCanvas *c6SD = new TCanvas("c6SD", " c6SD");
  c6SD->Divide(2,0,0.05);
  c6SD->cd(1);
  hQ2WSC->SetStats(0);
  Dcut->SetLineColor(kRed);
  hQ2WSC->Draw("COL");
  ...
  */
  //May 1, 2026
   //thesis plots  
  TCanvas *cthesisle = new TCanvas("cthesisle", " cthesisle");
  cthesisle->Divide(2,3);
  cthesisle->cd(1);
  hthQ2C->Add(hthQ2CR, -1);
  hthQ2C->Scale(ECLEC);
  hthQ2dC->Add(hthQ2dCR, -1);
  hthQ2dC->Scale(ECLEDC);
  hthQ2C->Add(hthQ2dC, -1);
  hthQ2SC->SetStats(0);
  hthQ2SC->SetLineColor(kRed);
  hthQ2SC->Scale(SSleC);
  hthQ2SC->Draw("hist"); 
  hthQ2C->SetStats(0);
  hthQ2C->Draw("same"); 
  ...
  hthWC->Add(hthWCR, -1);
  hthWC->Scale(ECLEC);
  hthWdC->Add(hthWdCR, -1);
  hthWdC->Scale(ECLEDC);
  hthWC->Add(hthWdC, -1);
  hthWSC->SetStats(0);
  hthWSC->SetLineColor(kRed);
  hthWSC->Scale(SSleC);
  hthWSC->Draw("hist");
  hthWC->SetStats(0);
  hthWC->Draw("same");
  ...
  hthepC->Add(hthepCR, -1);
  hthepC->Scale(ECLEC);
  hthepdC->Add(hthepdCR, -1);
  hthepdC->Scale(ECLEDC);
  hthepC->Add(hthepdC, -1);
  hthepSC->SetStats(0);
  hthepSC->SetLineColor(kRed);
  hthepSC->Scale(SSleC);
  hthepSC->Draw("hist");
  hthepC->SetStats(0);
  hthepC->Draw("same");
  ...
  H_ssdelta_SC->SetLineColor(kRed);
  H_ssdelta_SC->Scale(SSleC);
  H_ssdelta_SC->Draw("hist");
  H_ssdelta_DC->Add(H_ssdelta_DCR, -1);  
  H_ssdelta_DC->Scale(ECLEC);
  H_ssdelta_DdC->Add(H_ssdelta_DdCR, -1);  
  H_ssdelta_DdC->Scale(ECLEDC);
  H_ssdelta_DC->Add(H_ssdelta_DdC, -1);  
  H_ssdelta_DC->SetStats(0);
  H_ssdelta_DC->Draw("same"); 

  cAcc->cd(2);

  H_ssxptar_SC->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssxptar_SC->SetLineColor(kRed);
  H_ssxptar_SC->SetStats(0);
  H_ssxptar_SC->SetLineColor(kRed);
  H_ssxptar_SC->Scale(SSleC);
  H_ssxptar_SC->Draw("hist");
  H_ssxptar_DC->Add(H_ssxptar_DCR, -1);
  H_ssxptar_DC->Scale(ECLEC);
  H_ssxptar_DdC->Add(H_ssxptar_DdCR, -1);
  H_ssxptar_DdC->Scale(ECLEDC);
  H_ssxptar_DC->Add(H_ssxptar_DdC, -1);
  H_ssxptar_DC->SetStats(0);
  H_ssxptar_DC->Draw("same");
  ...
  H_ssyptar_SC->SetLineColor(kRed);
  H_ssyptar_SC->Scale(SSleC);
  H_ssyptar_SC->Draw("hist");
  H_ssyptar_DC->Add(H_ssyptar_DCR, -1);
  H_ssyptar_DC->Scale(ECLEC);
  H_ssyptar_DdC->Add(H_ssyptar_DdCR, -1);
  H_ssyptar_DdC->Scale(ECLEDC);
  H_ssyptar_DC->Add(H_ssyptar_DdC, -1);
  H_ssyptar_DC->SetStats(0);
  H_ssyptar_DC->Draw("same");
  ...
  H_hsdelta_SC->SetLineColor(kRed);
  H_hsdelta_SC->Scale(SSleC);
  H_hsdelta_SC->Draw("hist");
  H_hsdelta_DC->Add(H_hsdelta_DCR, -1);
  H_hsdelta_DC->Scale(ECLEC);
  ...
  H_hsxptar_SC->SetLineColor(kRed);
  H_hsxptar_SC->Scale(SSleC);
  H_hsxptar_SC->Draw("hist");
  H_hsxptar_DC->Add(H_hsxptar_DCR, -1);
  H_hsxptar_DC->Scale(ECLEC);
  H_hsxptar_DdC->Add(H_hsxptar_DdCR, -1);
  H_hsxptar_DdC->Scale(ECLEDC);
  H_hsxptar_DC->Add(H_hsxptar_DdC, -1);  
  H_hsxptar_DC->SetStats(0);
  H_hsxptar_DC->Draw("same ");
  ...
  H_hsyptar_SC->SetLineColor(kRed);
  H_hsyptar_SC->Scale(SSleC);
  H_hsyptar_SC->Draw("hist");
  H_hsyptar_DC->Add(H_hsyptar_DCR, -1);
  H_hsyptar_DC->Scale(ECLEC);
  H_hsyptar_DdC->Add(H_hsyptar_DdCR, -1);
  H_hsyptar_DdC->Scale(ECLEDC);
  H_hsyptar_DC->Add(H_hsyptar_DdC, -1);  
  H_hsyptar_DC->SetStats(0);
  H_hsyptar_DC->Draw("same");
  cAcc->Print(outputpdf);
  //Left1  
  TCanvas *cthesisleL1 = new TCanvas("cthesisleL1", " cthesisleL1");
  cthesisleL1->Divide(2,3);
  cthesisleL1->cd(1);
  hthQ2L1->Add(hthQ2L1R, -1);
  hthQ2L1->Scale(ECLEL1);
  hthQ2dL1->Add(hthQ2dL1R, -1);
  hthQ2dL1->Scale(ECLEDL1);
  hthQ2L1->Add(hthQ2dL1, -1);
  hthQ2SL1->SetStats(0);
  hthQ2SL1->SetLineColor(kRed);
  hthQ2SL1->Scale(SSleL1);
  hthQ2SL1->Draw("hist"); 
  hthQ2L1->SetStats(0);
  hthQ2L1->Draw("same"); 
  ...
  hthWL1->Add(hthWL1R, -1);
  hthWL1->Scale(ECLEL1);
  hthWdL1->Add(hthWdL1R, -1);
  hthWdL1->Scale(ECLEDL1);
  hthWL1->Add(hthWdL1, -1);
  hthWSL1->SetStats(0);
  hthWSL1->SetLineColor(kRed);
  hthWSL1->Scale(SSleL1);
  hthWSL1->Draw("hist");
  hthWL1->SetStats(0);
  hthWL1->Draw("same");
  ...
  hthepL1->Add(hthepL1R, -1);
  hthepL1->Scale(ECLEL1);
  hthepdL1->Add(hthepdL1R, -1);
  hthepdL1->Scale(ECLEDL1);
  hthepL1->Add(hthepdL1, -1);
  hthepSL1->SetStats(0);
  hthepSL1->SetLineColor(kRed);
  hthepSL1->Scale(SSleL1);
  hthepSL1->Draw("hist");
  hthepL1->SetStats(0);
  hthepL1->Draw("same");
  ...
  hphSL1->SetStats(0);
  hphSL1->SetLineColor(kRed);
  hphSL1->Scale(SSleL1);
  hphSL1->Draw("hist");
  hphL1->SetStats(0);
  hphL1->Add(hphL1R, -1);
  hphL1->Scale(ECLEL1);
  hphdL1->Add(hphdL1R, -1);
  hphdL1->Scale(ECLEDL1);
  hphL1->Add(hphdL1, -1);  
  hphL1->Draw("same");
   
  cthesisleL1->Print(outputpdf);
  //Acceptance later

  TCanvas *cAccL1 = new TCanvas("cAccL1", "cAccL1");
  cAccL1->Divide(2,3);
  cAccL1->cd(1);
  H_ssdelta_SL1->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssdelta_SL1->SetStats(0);
  H_ssdelta_SL1->SetLineColor(kRed);
  H_ssdelta_SL1->Scale(SSleL1);
  H_ssdelta_SL1->Draw("hist");
  H_ssdelta_DL1->Add(H_ssdelta_DL1R, -1);  
  H_ssdelta_DL1->Scale(ECLEL1);
  H_ssdelta_DdL1->Add(H_ssdelta_DdL1R, -1);  
  H_ssdelta_DdL1->Scale(ECLEDL1);
  H_ssdelta_DL1->Add(H_ssdelta_DdL1, -1);  
  H_ssdelta_DL1->SetStats(0);
  H_ssdelta_DL1->Draw("same"); 

  cAccL1->cd(2);

  H_ssxptar_SL1->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssxptar_SL1->SetLineColor(kRed);
  H_ssxptar_SL1->SetStats(0);
  H_ssxptar_SL1->SetLineColor(kRed);
  H_ssxptar_SL1->Scale(SSleL1);
  H_ssxptar_SL1->Draw("hist");
  H_ssxptar_DL1->Add(H_ssxptar_DL1R, -1);
  H_ssxptar_DL1->Scale(ECLEL1);
  H_ssxptar_DdL1->Add(H_ssxptar_DdL1R, -1);
  H_ssxptar_DdL1->Scale(ECLEDL1);
  H_ssxptar_DL1->Add(H_ssxptar_DdL1, -1);
  H_ssxptar_DL1->SetStats(0);
  H_ssxptar_DL1->Draw("same");

  cAccL1->cd(3);

  H_ssyptar_SL1->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssyptar_SL1->SetStats(0);
  H_ssyptar_SL1->SetLineColor(kRed);
  H_ssyptar_SL1->Scale(SSleL1);
  H_ssyptar_SL1->Draw("hist");
  H_ssyptar_DL1->Add(H_ssyptar_DL1R, -1);
  H_ssyptar_DL1->Scale(ECLEL1);
  H_ssyptar_DdL1->Add(H_ssyptar_DdL1R, -1);
  H_ssyptar_DdL1->Scale(ECLEDL1);
  H_ssyptar_DL1->Add(H_ssyptar_DdL1, -1);
  H_ssyptar_DL1->SetStats(0);
  H_ssyptar_DL1->Draw("same");
 
  cAccL1->cd(4);

  H_hsdelta_SL1->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsdelta_SL1->SetStats(0);
  H_hsdelta_SL1->SetLineColor(kRed);
  H_hsdelta_SL1->Scale(SSleL1);
  H_hsdelta_SL1->Draw("hist");
  H_hsdelta_DL1->Add(H_hsdelta_DL1R, -1);
  H_hsdelta_DL1->Scale(ECLEL1);
  H_hsdelta_DummyL1->Add(H_hsdelta_DummyL1R, -1);
  H_hsdelta_DummyL1->Scale(ECLEDL1);
  H_hsdelta_DL1->Add(H_hsdelta_DummyL1, -1); 
  H_hsdelta_DL1->SetStats(0);
  H_hsdelta_DL1->Draw("same "); 

  cAccL1->cd(5);

  H_hsxptar_SL1->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsxptar_SL1->SetStats(0);
  H_hsxptar_SL1->SetLineColor(kRed);
  H_hsxptar_SL1->Scale(SSleL1);
  H_hsxptar_SL1->Draw("hist");
  H_hsxptar_DL1->Add(H_hsxptar_DL1R, -1);
  H_hsxptar_DL1->Scale(ECLEL1);
  H_hsxptar_DdL1->Add(H_hsxptar_DdL1R, -1);
  H_hsxptar_DdL1->Scale(ECLEDL1);
  H_hsxptar_DL1->Add(H_hsxptar_DdL1, -1);  
  H_hsxptar_DL1->SetStats(0);
  H_hsxptar_DL1->Draw("same ");
  
  cAccL1->cd(6);

  H_hsyptar_SL1->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsyptar_SL1->SetStats(0);
  H_hsyptar_SL1->SetLineColor(kRed);
  H_hsyptar_SL1->Scale(SSleL1);
  H_hsyptar_SL1->Draw("hist");
  H_hsyptar_DL1->Add(H_hsyptar_DL1R, -1);
  H_hsyptar_DL1->Scale(ECLEL1);
  H_hsyptar_DdL1->Add(H_hsyptar_DdL1R, -1);
  H_hsyptar_DdL1->Scale(ECLEDL1);
  H_hsyptar_DL1->Add(H_hsyptar_DdL1, -1);  
  H_hsyptar_DL1->SetStats(0);
  H_hsyptar_DL1->Draw("same");
  cAccL1->Print(outputpdf);
   
  //Left2
  TCanvas *cthesisleL2 = new TCanvas("cthesisleL2", " cthesisleL2");
  cthesisleL2->Divide(2,3);
  cthesisleL2->cd(1);
  hthQ2L2->Add(hthQ2L2R, -1);
  hthQ2L2->Scale(ECLEL2);
  hthQ2dL2->Add(hthQ2dL2R, -1);
  hthQ2dL2->Scale(ECLEDL2);
  hthQ2L2->Add(hthQ2dL2, -1);
  hthQ2SL2->SetStats(0);
  hthQ2SL2->SetLineColor(kRed);
  hthQ2SL2->Scale(SSleL2);
  hthQ2SL2->Draw("hist"); 
  hthQ2L2->SetStats(0);
  hthQ2L2->Draw("same"); 
  ...
  hthWL2->Add(hthWL2R, -1);
  hthWL2->Scale(ECLEL2);
  hthWdL2->Add(hthWdL2R, -1);
  hthWdL2->Scale(ECLEDL2);
  hthWL2->Add(hthWdL2, -1);
  hthWSL2->SetStats(0);
  hthWSL2->SetLineColor(kRed);
  hthWSL2->Scale(SSleL2);
  hthWSL2->Draw("hist");
  hthWL2->SetStats(0);
  hthWL2->Draw("same");
  ...
  hthepL2->Add(hthepL2R, -1);
  hthepL2->Scale(ECLEL2);
  hthepdL2->Add(hthepdL2R, -1);
  hthepdL2->Scale(ECLEDL2);
  hthepL2->Add(hthepdL2, -1);
  hthepSL2->SetStats(0);
  hthepSL2->SetLineColor(kRed);
  hthepSL2->Scale(SSleL2);
  hthepSL2->Draw("hist");
  hthepL2->SetStats(0);
  hthepL2->Draw("same");
  ...
  hphSL2->SetStats(0);
  hphSL2->SetLineColor(kRed);
  hphSL2->Scale(SSleL2);
  hphSL2->Draw("hist");
  hphL2->SetStats(0);
  hphL2->Add(hphL2R, -1);
  hphL2->Scale(ECLEL2);
  hphdL2->Add(hphdL2R, -1);
  hphdL2->Scale(ECLEDL2);
  hphL2->Add(hphdL2, -1);  
  hphL2->Draw("same");
  cthesisleL2->Print(outputpdf);

  //Acceptance later
  TCanvas *cAccL2 = new TCanvas("cAccL2", "cAccL2");
  cAccL2->Divide(2,3);
  cAccL2->cd(1);
  H_ssdelta_SL2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssdelta_SL2->SetStats(0);
  H_ssdelta_SL2->SetLineColor(kRed);
  H_ssdelta_SL2->Scale(SSleL2);
  H_ssdelta_SL2->Draw("hist");
  H_ssdelta_DL2->Add(H_ssdelta_DL2R, -1);  
  H_ssdelta_DL2->Scale(ECLEL2);
  H_ssdelta_DdL2->Add(H_ssdelta_DdL2R, -1);  
  H_ssdelta_DdL2->Scale(ECLEDL2);
  H_ssdelta_DL2->Add(H_ssdelta_DdL2, -1);  
  H_ssdelta_DL2->SetStats(0);
  H_ssdelta_DL2->Draw("same"); 

  cAccL2->cd(2);

  H_ssxptar_SL2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssxptar_SL2->SetLineColor(kRed);
  H_ssxptar_SL2->SetStats(0);
  H_ssxptar_SL2->SetLineColor(kRed);
  H_ssxptar_SL2->Scale(SSleL2);
  H_ssxptar_SL2->Draw("hist");
  H_ssxptar_DL2->Add(H_ssxptar_DL2R, -1);
  H_ssxptar_DL2->Scale(ECLEL2);
  H_ssxptar_DdL2->Add(H_ssxptar_DdL2R, -1);
  H_ssxptar_DdL2->Scale(ECLEDL2);
  H_ssxptar_DL2->Add(H_ssxptar_DdL2, -1);
  H_ssxptar_DL2->SetStats(0);
  H_ssxptar_DL2->Draw("same");

  cAccL2->cd(3);

  H_ssyptar_SL2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssyptar_SL2->SetStats(0);
  H_ssyptar_SL2->SetLineColor(kRed);
  H_ssyptar_SL2->Scale(SSleL2);
  H_ssyptar_SL2->Draw("hist");
  H_ssyptar_DL2->Add(H_ssyptar_DL2R, -1);
  H_ssyptar_DL2->Scale(ECLEL2);
  H_ssyptar_DdL2->Add(H_ssyptar_DdL2R, -1);
  H_ssyptar_DdL2->Scale(ECLEDL2);
  H_ssyptar_DL2->Add(H_ssyptar_DdL2, -1);
  H_ssyptar_DL2->SetStats(0);
  H_ssyptar_DL2->Draw("same");
 
  cAccL2->cd(4);

  H_hsdelta_SL2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsdelta_SL2->SetStats(0);
  H_hsdelta_SL2->SetLineColor(kRed);
  H_hsdelta_SL2->Scale(SSleL2);
  H_hsdelta_SL2->Draw("hist");
  H_hsdelta_DL2->Add(H_hsdelta_DL2R, -1);
  H_hsdelta_DL2->Scale(ECLEL2);
  H_hsdelta_DummyL2->Add(H_hsdelta_DummyL2R, -1);
  H_hsdelta_DummyL2->Scale(ECLEDL2);
  H_hsdelta_DL2->Add(H_hsdelta_DummyL2, -1); 
  H_hsdelta_DL2->SetStats(0);
  H_hsdelta_DL2->Draw("same "); 

  cAccL2->cd(5);

  H_hsxptar_SL2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsxptar_SL2->SetStats(0);
  H_hsxptar_SL2->SetLineColor(kRed);
  H_hsxptar_SL2->Scale(SSleL2);
  H_hsxptar_SL2->Draw("hist");
  H_hsxptar_DL2->Add(H_hsxptar_DL2R, -1);
  H_hsxptar_DL2->Scale(ECLEL2);
  H_hsxptar_DdL2->Add(H_hsxptar_DdL2R, -1);
  H_hsxptar_DdL2->Scale(ECLEDL2);
  H_hsxptar_DL2->Add(H_hsxptar_DdL2, -1);  
  H_hsxptar_DL2->SetStats(0);
  H_hsxptar_DL2->Draw("same ");
  
  cAccL2->cd(6);

  H_hsyptar_SL2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsyptar_SL2->SetStats(0);
  H_hsyptar_SL2->SetLineColor(kRed);
  H_hsyptar_SL2->Scale(SSleL2);
  H_hsyptar_SL2->Draw("hist");
  H_hsyptar_DL2->Add(H_hsyptar_DL2R, -1);
  H_hsyptar_DL2->Scale(ECLEL2);
  H_hsyptar_DdL2->Add(H_hsyptar_DdL2R, -1);
  H_hsyptar_DdL2->Scale(ECLEDL2);
  H_hsyptar_DL2->Add(H_hsyptar_DdL2, -1);  
  H_hsyptar_DL2->SetStats(0);
  H_hsyptar_DL2->Draw("same");
  cAccL2->Print(outputpdf); 
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  histC[i][j]->Add(histCR[i][j], -1);
	  histC[i][j]->Scale(ECLEC);
	}
    }
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  // Double_t TotNoEvent = histC[j-2][i-2]->IntegralAndError(1, histC[j-2][i-2]->GetNbinsX(), err, "");
	  Double_t Yield = TotNoEvent*ECLEC;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLECErr*ECLEC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YleC<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;
	  
	  
	  // YleC<<hYC->IntegralAndError(j, j, i, i, err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
	  
	  //  YleC<<histC[j-2][i-2]->IntegralAndError(1, histC[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;   // MMpi cut already placed
	  // YleC<<histC[j-2][i-2]->IntegralAndError(histC[j-2][i-2]->FindBin(0.92), histC[j-2][i-2]->FindBin(0.98), err," ")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
	}
    } 
  YleC.close();
  hYdC->Add(hYdCR, -1);  
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  histdC[i][j]->Add(histdCR[i][j], -1);
	  histdC[i][j]->Scale(ECLEDC);
	  histdC[i][j]->Scale(THCF);
	}
    }
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t TotNoEvent = hYdC->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECLEDC;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLECErr*ECLEDC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdleC<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;
	  
	  //YdleC<<histdC[j-2][i-2]->IntegralAndError(1, histdC[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSCerr->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSC->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }

	  YSleC<<hYSC->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  

	  //YSleC<<hYSC->IntegralAndError(j, j, i, i, err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  

	  //YSleC<<histSC[j-2][i-2]->IntegralAndError(1, histSC[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  histL1[i][j]->Add(histL1R[i][j], -1);
	  histL1[i][j]->Scale(ECLEL1);
	}
    }
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t TotNoEvent = hYL1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECLEL1;	  
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLEL1Err*ECLEL1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YleL1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;

	  //YleL1<<histL1[j-2][i-2]->IntegralAndError(1, histL1[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;   // MMpi cut already placed
	}
    } 
  YleL1.close();
  hYdL1->Add(hYdL1R, -1);  
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  histdL1[i][j]->Add(histdL1R[i][j], -1);
	  histdL1[i][j]->Scale(ECLEDL1);
	  histdL1[i][j]->Scale(THCF);
	}
    }
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t TotNoEvent = hYdL1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECLEDL1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLEDL1Err*ECLEDL1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdleL1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;
	  
	  //YdleL1<<histdL1[j-2][i-2]->IntegralAndError(1, histdL1[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSL1err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSL1->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSleL1<<hYSL1->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	  
	  //	  YSleL1<<hYSL1->IntegralAndError(j, j, i, i, err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
      	  //YSleL1<<histSL1[j-2][i-2]->IntegralAndError(1, histSL1[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  histL2[i][j]->Add(histL2R[i][j], -1);
	  histL2[i][j]->Scale(ECLEL2);
	}
    }
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t TotNoEvent = hYL2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECLEL2;
	  
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLEL2Err*ECLEL2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YleL2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;

	  
	  //YleL2<<histL2[j-2][i-2]->IntegralAndError(1, histL2[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;   // MMpi cut already placed
  ...
  for(int i = 0; i < 8; i++)
    {
      for(int j =0; j <16; j++)
	{
	  histdL2[i][j]->Add(histdL2R[i][j], -1);
	  histdL2[i][j]->Scale(ECLEDL2);
	  histdL2[i][j]->Scale(THCF);
	}
    }
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t TotNoEvent = hYdL2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECLEDL2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLEDL2Err*ECLEDL2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }	  
	  YdleL2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;


	  //YdleL2<<histdL2[j-2][i-2]->IntegralAndError(1, histdL2[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSL2err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSL2->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSleL2<<hYSL2->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  

	  //  YSleL2<<hYSL2->IntegralAndError(j, j, i, i, err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	  //YSleL2<<histSL2[j-2][i-2]->IntegralAndError(1, histSL2[j-2][i-2]->GetNbinsX(), err, "")<<"\t"<<err<<"\t"<<j-1<<"\t"<<i-1 <<endl;
	}
    } 
  YSleL2.close();
  ...
  */ 
  ...
  hYSmeL1->Sumw2();
  hYSmeL2->Sumw2();
  TH2D *hYSmeR1err   = new TH2D("hYSmeR1err"," Yield SIMC R1;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSmeR2err   = new TH2D("hYSmeR2err"," Yield SIMC R2;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSmeCerr   = new TH2D("hYSmeCerr"," Yield SIMC C;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSmeL1err   = new TH2D("hYSmeL1err"," Yield SIMC L1;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSmeL2err   = new TH2D("hYSmeL2err"," Yield SIMC L2;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  ...
  */
  ...
  TH1D *hphmeC  = new TH1D("hphmeC","; Phi (deg);Yield (events/mC)",50, -10, 370);      
  TH1D *hphmeCR  = new TH1D("hphmeCR","ph_q; Phi (deg);Yield (events/mC)",  50, -10, 370);      
  TH1D *hphmeSC  = new TH1D("hphmeSC","ph_q; Phi (deg);Yield (events/mC)",50, -10, 370);      
  TH1D *hphmedC  = new TH1D("hphmedC","ph_q; Phi (deg);Yield (events/mC);",50, -10, 370);      
  TH1D *hphmedCR  = new TH1D("hphmedCR","ph_q; Phi (deg);Yield (events/mC);",  50, -10, 370);      
  ...
  */
  ...
  Double_t tOffsetmeC  = 0.0005;
  Double_t tOffsetmeL1  = 0.0005;
  Double_t tOffsetmeL2  = 0.001;
  */
  //Garth Number April 06, 26
  Double_t tOffsetmeR1 = 0.00045;
  Double_t tOffsetmeR2 = 0.00034;
  Double_t tOffsetmeC  = 0.00056;
  Double_t tOffsetmeL1  = 0.00063;
  Double_t tOffsetmeL2  = 0.00054;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDER1; i++)
	...
	htcoinmeR1->Fill(tcoinmeR1-TimmingOffset);
      ...
      Double_t MMpiR1 = mmmeR1+MMpiOffsetmeR1>=MMPICUTL && mmmeR1+MMpiOffsetmeR1<=MMPICUTH;
      Double_t CoinPionR1 = tcoinmeR1-TimmingOffset>=-1.0-COINCUTDEP && tcoinmeR1-TimmingOffset <= 1.0+COINCUTDEP;      
	...
	{      
	  MPimeR1->Fill(mmmeR1+MMpiOffsetmeR1);
	}
      ...
      if(CoinPionR1 && MMpiR1 && DiamondR1)
	{
	  ...
	  hthtmeR1->Fill(-tmeR1+tOffsetmeR1);
	  htmeR1->Fill(-tmeR1);
	  htmeInR1->Fill(-tmeR1);
	  hph_qmeR1->Fill(ph_qmeR1*57.2958 + 180);
	  // hphmeR1->Fill(ph_qmeR1*57.2958 + 180);
	  hphmeR1->Fill(std::fmod(ph_qmeR1 * 180.0 / TMath::Pi() + 360.0,360.0));

 	  //hphmeR1->Fill(mmmeR1+MMpiOffsetmeR1);
	  hYmeR1->Fill(-tmeR1+tOffsetmeR1, std::fmod(ph_qmeR1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYmeR1->Fill(-tmeR1, mmmeR1+MMpiOffsetmeR1);
	}
      //Random
      if(CoinPionR1R && DiamondR1)
	{
	  MPimeR1R->Fill(mmmeR1+MMpiOffsetmeR1);
	}
      if(CoinPionR1R && MMpiR1 && DiamondR1)
	{
	  ...
	  hthtmeR1R->Fill(-tmeR1+tOffsetmeR1);
	  htmeR1R->Fill(-tmeR1);
	  htmeInR1R->Fill(-tmeR1);
	  hph_qmeR1R->Fill(ph_qmeR1*57.2958 + 180);
	  hphmeR1R->Fill(std::fmod(ph_qmeR1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  
 	  //hphmeR1R->Fill(mmmeR1+MMpiOffsetmeR1);
	  hYmeR1R->Fill(-tmeR1+tOffsetmeR1, std::fmod(ph_qmeR1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDR1; i++)
    {
      ...
      Double_t MMpidR1 = mmmedR1+MMpiOffsetmeR1>=MMPICUTL && mmmedR1+MMpiOffsetmeR1<=MMPICUTH;
      Double_t CoinPiondR1 = tcoinmedR1-TimmingOffset>=-1.0-COINCUTDEP && tcoinmedR1-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPiondR1 && DimonddR1)
	{
	  MPimedR1->Fill(mmmedR1+MMpiOffsetmeR1);
	}
      if(CoinPiondR1 && MMpidR1 && DimonddR1)
	{
	  hYmedR1->Fill(-tmedR1+tOffsetmeR1, std::fmod(ph_qmedR1 * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYmedR1->Fill(-tmedR1, mmmedR1+MMpiOffsetmeR1);
	  hthtmedR1->Fill(-tmedR1+tOffsetmeR1);
	}
      
      //Random
      if(CoinPiondR1R && DimonddR1)
	{
	  MPimedR1R->Fill(mmmedR1+MMpiOffsetmeR1);
	}
      if(CoinPiondR1R && MMpidR1 && DimonddR1)
	{
	  hYmedR1R->Fill(-tmedR1+tOffsetmeR1, std::fmod(ph_qmedR1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC RIGHT1                                                                                                                                                                                      
  Double_t normfacmeR1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_right1.hist");
  Double_t NFMR1 = normfacmeR1/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCMIDER1; i++)

    {
      ...
      //     Double_t NFMR1 = 22570100/400000.0;
      //      Double_t NFMR1 = 22984800/400000.0;
      // Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_right1.hist");
      // Double_t NFMR1 = normfac/400000.0;

      // Double_t NFMR1 = 23061900/400000.0;
      //RadiativeStudy
      //Double_t NFMR1 = 24131600.0/400000.0;
	...
	//hsdeltameR1 > -8.0 && hsdeltameR1 < 8.0 && hsxptarmeR1 > -0.08 && hsxptarmeR1 < 0.08 && hsyptarmeR1 > -0.045 && hsyptarmeR1 < 0.045 && ssdeltameR1 >=-10.0 && ssdeltameR1 <=20.0 && ssxptarmeR1 > -0.06 && ssxptarmeR1 < 0.06 && ssyptarmeR1 > -0.04 && ssyptarmeR1 < 0.04 && Diamond_cut;
      ...
      if(CUTSIMCMER12)
	{
	  MPiSmeR1->Fill(missmassmeR1, NFMR1*WeightmeR1);
	}
      if(CUTSIMCMER1)
	{
	  ...
	  hYSmeR1err->Fill(t_simcmeR1,phipqmeR1*57.2958);
	  ...
	  hthtSmeR1->Fill(t_simcmeR1,NFMR1*WeightmeR1);
	}
    }
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDER2; i++)
	...
	htcoinmeR2->Fill(tcoinmeR2-TimmingOffset);
      ...
      Double_t MMpiR2 = mmmeR2+MMpiOffsetmeR2>=MMPICUTL && mmmeR2+MMpiOffsetmeR2 <=MMPICUTH;
      Double_t CoinPionR2 = tcoinmeR2-TimmingOffset>=-1.0-COINCUTDEP && tcoinmeR2-TimmingOffset <=1.0+COINCUTDEP;      
	...
	{      
	  MPimeR2->Fill(mmmeR2+MMpiOffsetmeR2);
	}
      ...
      if(CoinPionR2 && MMpiR2 && DiamondR2)
	{
	  ...
	  hthtmeR2->Fill(-tmeR2+tOffsetmeR2);
	  htmeR2->Fill(-tmeR2);
	  htmeInR2->Fill(-tmeR2);
	  hph_qmeR2->Fill(ph_qmeR2*57.2958 + 180);
	  hphmeR2->Fill(std::fmod(ph_qmeR2 * 180.0 / TMath::Pi() + 360.0,360.0));
 	  //hphmeR2->Fill(mmmeR2+MMpiOffsetmeR2);
	  hYmeR2->Fill(-tmeR2+tOffsetmeR2, std::fmod(ph_qmeR2 * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYmeR2->Fill(-tmeR2, mmmeR2+MMpiOffsetmeR2);
	}
      //Random
      if(CoinPionR2R && DiamondR2)
	{
	  MPimeR2R->Fill(mmmeR2+MMpiOffsetmeR2);
	}
      if(CoinPionR2R && MMpiR2 && DiamondR2)
	{
	  ...
	  hthtmeR2R->Fill(-tmeR2+tOffsetmeR2);
	  htmeR2R->Fill(-tmeR2);
	  htmeInR2R->Fill(-tmeR2);
	  hph_qmeR2R->Fill(ph_qmeR2*57.2958 + 180);
	  hphmeR2R->Fill(std::fmod(ph_qmeR2 * 180.0 / TMath::Pi() + 360.0,360.0));
 	  //hphmeR2R->Fill(mmmeR2+MMpiOffsetmeR2);
	  hYmeR2R->Fill(-tmeR2+tOffsetmeR2, std::fmod(ph_qmeR2 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDR2; i++)
    {
      ...
      Double_t MMpidR2 = mmmedR2+MMpiOffsetmeR2>=MMPICUTL && mmmedR2+MMpiOffsetmeR2<=MMPICUTH;
      Double_t CoinPiondR2 = tcoinmedR2-TimmingOffset>=-1.0-COINCUTDEP && tcoinmedR2-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPiondR2 && DimonddR2)
	{
	  MPimedR2->Fill(mmmedR2+MMpiOffsetmeR2);
	}
      if(CoinPiondR2 && MMpidR2 && DimonddR2)
	{
	  hYmedR2->Fill(-tmedR2+tOffsetmeR2, std::fmod(ph_qmedR2 * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYmedR2->Fill(-tmedR2, mmmedR2+MMpiOffsetmeR2);
	  hthtmedR2->Fill(-tmedR2+tOffsetmeR2);
	}
      
      //Random
      if(CoinPiondR2R && DimonddR2)
	{
	  MPimedR2R->Fill(mmmedR2+MMpiOffsetmeR2);
	}
      if(CoinPiondR2R && MMpidR2 && DimonddR2)
	{
	  hYmedR2R->Fill(-tmedR2+tOffsetmeR2, std::fmod(ph_qmeR2 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC RIGHT2                                                                                                                                                                                      
  Double_t normfacmeR2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_right2.hist");
  Double_t NFMR2 = normfacmeR2/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCMIDER2; i++)

    {
      ...
      //      Double_t NFMR2 = 22551600/400000.0;
      // Double_t NFMR2 = 22957100/400000.0;
      //Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_right2.hist");
      //Double_t NFMR2 = normfac/400000.0;

      //   Double_t NFMR2 = 22940900/400000.0;
      //RadiativeStudy
      //Double_t NFMR2 = 24103400.0/400000.0;
	...
	//hsdeltameR2 > -8.0 && hsdeltameR2 < 8.0 && hsxptarmeR2 > -0.08 && hsxptarmeR2 < 0.08 && hsyptarmeR2 > -0.045 && hsyptarmeR2 < 0.045 && ssdeltameR2 > -10.0 && ssdeltameR2 < 20.0 && ssxptarmeR2 > -0.06 && ssxptarmeR2 < 0.06 && ssyptarmeR2 > -0.04 && ssyptarmeR2 < 0.04 && Diamond_cut;
      ...
      if(CUTSIMCMER22)	
	{
	  MPiSmeR2->Fill(missmassmeR2, NFMR2*WeightmeR2);
	}
      if(CUTSIMCMER2)	
        {
	  ...
	  hYSmeR2err->Fill(t_simcmeR2,phipqmeR2*57.2958);
	  ...
	  hthtSmeR2->Fill(t_simcmeR2,NFMR2*WeightmeR2);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEC; i++)
	...
	htcoinmeC->Fill(tcoinmeC-TimmingOffset);
      ...
      Double_t CoinPionC = tcoinmeC-TimmingOffset>=-1.0-COINCUTDEP && tcoinmeC-TimmingOffset <=1.0+COINCUTDEP;      
      ...
      if(CoinPionC && MMpiC && DiamondC)
	{
	  ...
	  hYmeC->Fill(-tmeC+tOffsetmeC, std::fmod(ph_qmeC * 180.0 / TMath::Pi() + 360.0,360.0));
     ...
     if(CoinPionCR && MMpiC && DiamondC)
	  ...
	  htmeCR->Fill(-tmeC);
	  htmeInCR->Fill(-tmeC);
	  hph_qmeCR->Fill(std::fmod(ph_qmeC * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYmeCR->Fill(-tmeC, mmmeC+MMpiOffsetmeC);
	  hYmeCR->Fill(-tmeC+tOffsetmeC, std::fmod(ph_qmeC * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDC; i++)
    {
      ...
      Double_t CoinPiondC = tcoinmedC-TimmingOffset>=-1.0-COINCUTDEP && tcoinmedC-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPiondC && MMpidC && DimonddC)
	{
	  ...
	  hphmedC->Fill(std::fmod(ph_qmedC * 180.0 / TMath::Pi() + 360.0,360.0));
	  hYmedC->Fill(-tmedC+tOffsetmeC, std::fmod(ph_qmedC * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPiondCR && MMpidC && DimonddC)
	{
	  ...
	  hphmedCR->Fill(std::fmod(ph_qmedC * 180.0 / TMath::Pi() + 360.0,360.0));
	  hYmedCR->Fill(-tmedC+tOffsetmeC, std::fmod(ph_qmedC * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC CENTER                                                                                                                                                                                      
  Double_t normfacmeC = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_center.hist");
  Double_t NFMC = normfacmeC/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEC; i++)

    {
      ...
      //Double_t NFMC = 22514500/400000.0;
      //samevk april 24, 2026 Double_t NFMC = 23135600/400000.0;
      //Double_t NFMC = 22882700/4000000.0;
      //Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_center.hist");
      //Double_t NFMC = normfac/400000.0;
      //Double_t NFMC = 22884900/400000.0;
      //RadiativeStudy
      //Double_t NFMC = 24017100.0/400000.0;

      // Double_t CUTSIMCMEC = (hsdeltameC >=-20.0 && hsdeltameC <=20.0 && hsxpfpmeC >=-0.08 && hsxpfpmeC <=0.08 && hsypfpmeC >=-0.045 && hsypfpmeC <=0.045 && ssdeltameC >=-10.0 && ssdeltameC <=20.0 && ssxpfpmeC >=-0.06 && ssxpfpmeC <=0.06 && ssypfpmeC >=-0.04 && ssypfpmeC <=0.04 && missmassmeC >=0.91  && missmassmeC <= 0.98 && Diamond_cut);
      ...
      if(CUTSIMCMEC)
	{
	  ...
	  hYSmeCerr->Fill(t_simcmeC,phipqmeC*57.2958);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEL1; i++)
	...
	htcoinmeL1->Fill(tcoinmeL1-TimmingOffset);
      ...
      Double_t CoinPionL1 = tcoinmeL1-TimmingOffset>=-1.0-COINCUTDEP && tcoinmeL1-TimmingOffset<=1.0+COINCUTDEP;      
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  hYmeL1->Fill(-tmeL1+tOffsetmeL1, std::fmod(ph_qmeL1 * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPionL1R && MMpiL1 && DiamondL1) 	
	{
	  ...
	  hYmeL1R->Fill(-tmeL1+tOffsetmeL1, std::fmod(ph_qmeL1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDL1; i++)
    {
      ...
      Double_t CoinPiondL1 = tcoinmedL1-TimmingOffset>=-1.0-COINCUTDEP && tcoinmedL1-TimmingOffset <= 1.0+COINCUTDEP;      
	...
	{
	  hYmedL1->Fill(-tmedL1+tOffsetmeL1, std::fmod(ph_qmedL1 * 180.0 / TMath::Pi() + 360.0,360.0));
	...
	{
	  hYmedL1R->Fill(-tmedL1+tOffsetmeL1, std::fmod(ph_qmedL1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC LEFT1                                                 
  Double_t normfacmeL1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_left1.hist");
  Double_t NFML1 = normfacmeL1/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL1; i++)

    {
      ...
      //Double_t NFML1 = 22405200/400000.0;
      //Double_t NFML1 = 24443600/4000000.0;
      //Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_left1.hist");
      //Double_t NFML1 = normfac/400000.0;
      //Double_t NFML1 = 23195200/400000.0;
      //RadiativeStudy
      //Double_t NFML1 = 23957600.0/400000.0;
      ...
      if(CUTSIMCMEL1)
	{
	  ...
	  hYSmeL1err->Fill(t_simcmeL1,phipqmeL1*57.2958);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEL2; i++)
	...
	htcoinmeL2->Fill(tcoinmeL2-TimmingOffset);
      ...
      Double_t CoinPionL2 = tcoinmeL2-TimmingOffset>=-1.0-COINCUTDEP && tcoinmeL2-TimmingOffset<=1.0+COINCUTDEP;      
	...
	
	{
	  ...
	  hYmeL2->Fill(-tmeL2, std::fmod(ph_qmeL2 * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPionL2R && MMpiL2 && DiamondL2)
	{
	  ...
	  hYmeL2R->Fill(-tmeL2+tOffsetmeL2, std::fmod(ph_qmeL2 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDL2; i++)
    {
      ...
      Double_t CoinPiondL2 = tcoinmedL2-TimmingOffset>=-1.0-COINCUTDEP && tcoinmedL2-TimmingOffset<= 1.0+COINCUTDEP;      
	...
	{
	  hYmedL2->Fill(-tmedL2+tOffsetmeL2, std::fmod(ph_qmedL2 * 180.0 / TMath::Pi() + 360.0,360.0));
	...
	{
	  hYmedL2R->Fill(-tmedL2+tOffsetmeL2, std::fmod(ph_qmedL2 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC LEFT2                                                 
  Double_t normfacmeL2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_left2.hist");
  Double_t NFML2 = normfacmeL2/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL2; i++)

    {
      ...
      //     Double_t NFML2 = 22241600.0/400000.0;
      // Double_t NFML2 = 23159500.0/400000.0;
      //Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q1_left2.hist");
      //Double_t NFML2 = normfac/400000.0;

      //    Double_t NFML2 = 23199500.0/400000.0;
      //RadiativeStudy    
      //Double_t NFML2 = 23912200.0/400000.0;
      ...
      if(CUTSIMCMEL22)	
	{
	  ...
	  hYSmeL2err->Fill(t_simcmeL2,phipqmeL2*57.2958);
  ...
  */
  Double_t ECMER1   = 1.0/185.91611536210158;
  Double_t ECMER1err   = 0.3563820628618087;
  Double_t ECMEDR1  = 1.0/37.071598004096224;
  Double_t ECMEDR1err  = 0.026225165664803537;
  /*
  Double_t ECMER2   = 1.0/312.09665;
  Double_t ECMEDR2  = 1.0/51.3116;
  */
  Double_t ECMER2   = 1.0/283.06794984365376;
  Double_t ECMER2err   = 0.7758722897060146;
  Double_t ECMEDR2  = 1.0/46.538983231953836;
  Double_t ECMEDR2err  = 0.06681804518625116;
  /*
  Double_t ECMEC    = 1.0/249.1794; 
  Double_t ECMEDC   = 1.0/34.8308;
  */
  Double_t ECMEC    = 1.0/226.00277593598065;    
  Double_t ECMECerr = 0.43331631002193194;    
  Double_t ECMEDC   = 1.0/31.591111575679665;     
  Double_t ECMEDCerr = 0.020177260910107325;     
  /*
  Double_t ECMEL1   = 1.0/331.0347;
  Double_t ECMEDL1  = 1.0/26.2649;
  */
  Double_t ECMEL1   = 1.0/300.24469623868634;
  Double_t ECMEL1err = 0.578529873623601;
  Double_t ECMEDL1  = 1.0/23.821918544619017;
  Double_t ECMEDL1err = 0.015013012227454376;
  /*
  Double_t ECMEL2   = 1.0/405.2875;
  Double_t ECMEDL2  = 1.0/54.3235;
  */
  Double_t ECMEL2   = 1.0/367.59088821906505;
  Double_t ECMEL2err   = 0.6903116974637672;
  Double_t ECMEDL2  = 1.0/49.270816085150464;
  Double_t ECMEDL2err  = 0.027735150390589786;
  ...
  TLine *l1me = new TLine(-1.0, 0.0, -1.0, 80.0);
  TLine *l2me = new TLine(1.0, 0.0, 1.0, 80.0);
  TLine *l3me = new TLine(-15.0, 0.0, -15.0, 80.0);
  TLine *l4me = new TLine(-9.0, 0.0, -9.0, 80.0);
  TLine *l5me = new TLine(7.0, 0.0, 7.0, 80.0);
  TLine *l6me = new TLine(13.0, 0.0, 13.0, 80.0);
  ...
  auto legme = new TLegend(0.2,0.4,0.50,0.9);
  ...
  //This made to conduct a pion decay systematic uncertainty study
  // June 06, 26, VK
  /*
  TCanvas *cVK = new TCanvas("cVK", "cVK"); 
  hthtSmeC->Divide(hthtSmeL1);
  hthtSmeC->GetYaxis()->SetTitle("Ratio (Decay On / Decay Off)");
  hthtSmeC->SetMinimum(0.0);
  hthtSmeC->SetMaximum(2.0);
  
  TH1* hRatio = hthtSmeC; // your histogram
  
  double xMin = 0.00595;
  double xMax = 0.060;
  
  FlatFitResult res = FitFlatRatio(hRatio, xMin, xMax);
  TPaveText* box = new TPaveText(0.15, 0.70, 0.45, 0.88, "NDC"); // NDC = normalized canvas coordinates
  
  box->SetFillColor(0);
  box->SetBorderSize(1);
  box->SetTextAlign(12);

  box->AddText(Form("Constant = %.5f", res.constant));
  box->AddText(Form("Centroid = %.5f", res.centroid));
  ...
  **/
  ...
  cthesiMPisme3->SetLogy();
  //VK April 16, 2026, plot for PRL paper
  /*
   TCanvas *cthesiMPisme3 = new TCanvas("cthesiMPisme3", "cthesiMPisme3",800,600);
   cthesiMPisme3->SetFillColor(0);
   cthesiMPisme3->SetBorderMode(0);
   cthesiMPisme3->SetFrameBorderMode(0);
   cthesiMPisme3->SetLeftMargin(0.14);
   cthesiMPisme3->SetBottomMargin(0.14);
   cthesiMPisme3->SetRightMargin(0.04);
   cthesiMPisme3->SetTopMargin(0.05);
  */  
  ...
  Double_t InmpimeC = MPimeC->Integral(XmpimeC->FindBin(MMPICUTL), XmpimeC->FindBin(MMPICUTH), "");
  TAxis *XmpiSmeC = MPiSmeC->GetXaxis();
  Double_t InmpiSmeC = MPiSmeC->Integral(XmpiSmeC->FindBin(MMPICUTL), XmpiSmeC->FindBin(MMPICUTH), "");
  Double_t SSmeC = InmpimeC/InmpiSmeC; 

  cout<< " SSmeC = "<< SSmeC <<endl;

  //Dummy yield to check how much
  /*
  TAxis *XmpimedC = MPimedC->GetXaxis();
  Double_t InmpimedC = MPimedC->Integral(XmpimedC->FindBin(MMPICUTL), XmpimedC->FindBin(MMPICUTH), "");
  cout<< " Dummy % meC = "<< (InmpimedC) <<endl;
  cout<< " Dummy % meC = "<< (InmpimeC) <<endl;
  */
  ...
  //VK April 16, 2026, plot for PRL paper
  /*
  MPiSmeC->GetXaxis()->SetTitle("Missing Mass (GeV)");
  MPiSmeC->GetYaxis()->SetTitle("Yield (Events/mC)");

  MPiSmeC->GetXaxis()->CenterTitle();
  MPiSmeC->GetYaxis()->CenterTitle();

  MPiSmeC->GetXaxis()->SetTitleSize(0.050);
  MPiSmeC->GetYaxis()->SetTitleSize(0.050);

  MPiSmeC->GetXaxis()->SetLabelSize(0.045);
  MPiSmeC->GetYaxis()->SetLabelSize(0.045);

  MPiSmeC->GetXaxis()->SetTitleOffset(1.10);
  MPiSmeC->GetYaxis()->SetTitleOffset(1.35);

  MPiSmeC->GetXaxis()->SetNdivisions(505);
  MPiSmeC->GetYaxis()->SetNdivisions(505);

  MPiSmeC->SetMinimum(0.0);
  */
  MPiSmeC->Scale(SSmeC);
  MPiSmeC->Draw("hist");
  MPimeC->SetStats(0);
  MPimeC->Draw("same");
  TLine *MMpil1me = new TLine(MMPICUTL, 0.0, MMPICUTL, 2.0);
  TLine *MMpil2me = new TLine(MMPICUTH, 0.0, MMPICUTH, 2.0);
  //MM scan
  TLine *MMpil3me = new TLine(MMPICUTH-0.002, 0.0, MMPICUTH-0.002, 1.0);
  TLine *MMpil4me = new TLine(MMPICUTH-0.004, 0.0, MMPICUTH-0.004, 1.0);
  TLine *MMpil5me = new TLine(MMPICUTH-0.006, 0.0, MMPICUTH-0.006, 1.0);
  TLine *MMpil6me = new TLine(MMPICUTH-0.008, 0.0, MMPICUTH-0.008, 1.0);
  TLine *MMpil7me = new TLine(MMPICUTH+0.002, 0.0, MMPICUTH+0.002, 1.0);
  TLine *MMpil8me = new TLine(MMPICUTH+0.004, 0.0, MMPICUTH+0.004, 1.0);
  TLine *MMpil9me = new TLine(MMPICUTH+0.006, 0.0, MMPICUTH+0.006, 1.0);
  TLine *MMpil10me = new TLine(MMPICUTH+0.008, 0.0, MMPICUTH+0.008,1.0);
  ...
  MMpil10me->Draw("same");
  /*
  cthesiMPisme3->SaveAs("prl_Miss_Mass.pdf");
  cthesiMPisme3->SaveAs("prl_Miss_Mass.eps");
  */
  ...
  cthesiMPisme1->cd(1);
  MPimeR2->Add(MPimeR2R, -1);
  MPimeR2->Scale(ECMER2);
  MPimedR2->Add(MPimedR2R, -1);
  MPimedR2->Scale(ECMEDR2);
  MPimeR2->Add(MPimedR2, -1);
  MPiSmeR2->SetStats(0);
  TAxis *XmpimeR2 = MPimeR2->GetXaxis();
  Double_t InmpimeR2 = MPimeR2->Integral(XmpimeR2->FindBin(MMPICUTL), XmpimeR2->FindBin(MMPICUTH), "");
  TAxis *XmpiSmeR2 = MPiSmeR2->GetXaxis();
  Double_t InmpiSmeR2 = MPiSmeR2->Integral(XmpiSmeR2->FindBin(MMPICUTL), XmpiSmeR2->FindBin(MMPICUTH), "");
  Double_t SSmeR2 = InmpimeR2/InmpiSmeR2; 
  MPiSmeR2->SetLineColor(kRed);
  MPiSmeR2->Scale(SSmeR2);
  MPiSmeR2->Draw("hist");
  MPimeR2->SetStats(0);
  MPimeR2->Draw("same");
  ...
  TAxis *XmpimeR1 = MPimeR1->GetXaxis();
  Double_t InmpimeR1 = MPimeR1->Integral(XmpimeR1->FindBin(MMPICUTL), XmpimeR1->FindBin(MMPICUTH), "");
  TAxis *XmpiSmeR1 = MPiSmeR1->GetXaxis();
  Double_t InmpiSmeR1 = MPiSmeR1->Integral(XmpiSmeR1->FindBin(MMPICUTL), XmpiSmeR1->FindBin(MMPICUTH), "");
  Double_t SSmeR1 = InmpimeR1/InmpiSmeR1; 
  MPiSmeR1->Scale(SSmeR1);
  MPiSmeR1->SetStats(0);
  ...
  TAxis *XmpimeL1 = MPimeL1->GetXaxis();
  Double_t InmpimeL1 = MPimeL1->Integral(XmpimeL1->FindBin(MMPICUTL), XmpimeL1->FindBin(MMPICUTH), "");
  TAxis *XmpiSmeL1 = MPiSmeL1->GetXaxis();
  Double_t InmpiSmeL1 = MPiSmeL1->Integral(XmpiSmeL1->FindBin(MMPICUTL), XmpiSmeL1->FindBin(MMPICUTH), "");
  Double_t SSmeL1 = InmpimeL1/InmpiSmeL1; 
  MPiSmeL1->Scale(SSmeL1);
  MPiSmeL1->SetStats(0);
  ...
  TAxis *XmpimeL2 = MPimeL2->GetXaxis();
  Double_t InmpimeL2 = MPimeL2->Integral(XmpimeL2->FindBin(MMPICUTL), XmpimeL2->FindBin(MMPICUTH), "");
  TAxis *XmpiSmeL2 = MPiSmeL2->GetXaxis();
  Double_t InmpiSmeL2 = MPiSmeL2->Integral(XmpiSmeL2->FindBin(MMPICUTL), XmpiSmeL2->FindBin(MMPICUTH), "");
  Double_t SSmeL2 = InmpimeL2/InmpiSmeL2; 
  MPiSmeL2->Scale(SSmeL2);
  MPiSmeL2->SetStats(0);
  ...
  */
  ...
  for(int j=1; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmeR1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMER1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMER1err*ECMER1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YmeR1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YmeR1.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmedR1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEDR1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEDR1err*ECMEDR1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdmeR1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdmeR1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSmeR1err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSmeR1->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSmeR1<<hYSmeR1->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSmeR1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmeR2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMER2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMER2err*ECMER2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YmeR2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YmeR2.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmedR2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEDR2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEDR2err*ECMEDR2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdmeR2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSmeR2err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSmeR2->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	  ...
	  YSmeR2<<hYSmeR2->IntegralAndError(j, j, i, i, err, "")<<"\t"<< Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSmeR2.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmeC->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEC;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMECerr*ECMEC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YmeC<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YmeC.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmedC->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEDC;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEDCerr*ECMEDC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdmeC<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdmeC.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSmeCerr->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSmeC->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	  ...
	  YSmeC<<hYSmeC->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSmeC.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmeL1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEL1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEL1err*ECMEL1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YmeL1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YmeL1.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmedL1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEDL1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEDL1err*ECMEDL1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YdmeL1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdmeL1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSmeL1err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSmeL1->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	  ...
	  YSmeL1<<hYSmeL1->IntegralAndError(j, j, i, i, err, "")<<"\t"<< Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSmeL1.close();
  ...
  for(int j=1; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmeL2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEL2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEL2err*ECMEL2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YmeL2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YmeL2.close();
  //Dummy
  ...
  for(int j=1 ; j <=10; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYmedL2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECMEDL2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECMEDL2err*ECMEDL2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YdmeL2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdmeL2.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSmeL2err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSmeL2->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSmeL2<<hYSmeL2->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSmeL2.close();
...
// =========================================================================
// 1. GLOBAL PRL/APS STYLE CONFIGURATION (Apply before creating the canvas)
// =========================================================================
gROOT->SetBatch(kTRUE); // Suppress window pop-ups during processing
TStyle *prlStyle1 = new TStyle("prlStyle1", "PRL Publication Style");

// White background canvases and pads
prlStyle1->SetCanvasColor(kWhite);
prlStyle1->SetPadColor(kWhite);
prlStyle1->SetFrameFillColor(kWhite);
prlStyle1->SetCanvasBorderMode(0);
prlStyle1->SetPadBorderMode(0);
prlStyle1->SetFrameBorderMode(0);

// Default high-density margins 
prlStyle1->SetPadLeftMargin(0.15);  // Gives ample breathing room for "Yield (Events/mC)"
prlStyle1->SetPadRightMargin(0.04);
//prlStyle->SetPadTopMargin(0.08);   // Clearance room for panel index markers (a, b, c...)
//prlStyle->SetPadBottomMargin(0.20);

// Font Remapping: Font code 132 represents Times New Roman
int font_type1 = 132;
prlStyle1->SetTextFont(font_type1);
prlStyle1->SetLabelFont(font_type1, "XYZ");
prlStyle1->SetTitleFont(font_type1, "XYZ");

// Publication text scaling and positioning offsets
prlStyle1->SetLabelSize(0.05, "XYZ");
prlStyle1->SetTitleSize(0.06, "XYZ");
prlStyle1->SetTitleOffset(1.20, "Y"); // Prevents label crushing against tick numbers
prlStyle1->SetTitleOffset(2.05, "X");

// APS Standard: Inward pointing tick marks framing all four canvas corridors
prlStyle1->SetPadTickX(1);
prlStyle1->SetPadTickY(1);

// Hide default text banners (captions belong in your LaTeX file instead)
prlStyle1->SetOptTitle(0);
prlStyle1->SetOptStat(0);

gROOT->SetStyle("prlStyle1");
gROOT->ForceStyle();

// =========================================================================
// 2. CONVERTED INTERACTIVE CODE SECTION
// =========================================================================
// Width: Height proportion is set to match your 2-column, 3-row layout architecture
// Width: Height proportion is set to match your 2-column, 3-row layout architecture

  TCanvas *cthesisme = new TCanvas("cthesisme", "cthesisme");                                                                                                             
  cthesisme->Divide(2, 3, 0.005, 0.005); // Sets explicit tight margins between pads                                                                                                                                                     
  cthesisme->cd(1);
  gPad->SetTopMargin(0.0);
  gPad->SetBottomMargin(0.20);
  hthQ2SmeC->SetStats(0);
  hthQ2SmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  hthQ2SmeC->GetXaxis()->SetTitle("Four-Momentum Transfer Squared, Q^{2} (GeV^{2})"); // Replace with your exact X-variable name
  hthQ2SmeC->GetXaxis()->CenterTitle(true);
  
  hthQ2SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  hthQ2SmeC->GetXaxis()->SetTitleFont(133);
  hthQ2SmeC->GetYaxis()->SetLabelFont(133);
  hthQ2SmeC->GetXaxis()->SetLabelFont(133);
  
  hthQ2SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  hthQ2SmeC->GetXaxis()->SetTitleSize(15);
  hthQ2SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  hthQ2SmeC->GetXaxis()->SetLabelSize(14);
  
  hthQ2SmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  hthQ2SmeC->GetXaxis()->SetTitleOffset(2.5);
  ...
  gPad->SetBottomMargin(0.20);
  hthWSmeC->SetStats(0);
  hthWSmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  hthWSmeC->GetXaxis()->SetTitle("Invariant Mass, W (GeV)"); // Replace with your exact X-variable name
  hthWSmeC->GetXaxis()->CenterTitle(true);
  
  hthWSmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  hthWSmeC->GetXaxis()->SetTitleFont(133);
  hthWSmeC->GetYaxis()->SetLabelFont(133);
  hthWSmeC->GetXaxis()->SetLabelFont(133);
  
  hthWSmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  hthWSmeC->GetXaxis()->SetTitleSize(15);
  hthWSmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  hthWSmeC->GetXaxis()->SetLabelSize(14);
  
  hthWSmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  hthWSmeC->GetXaxis()->SetTitleOffset(2.5);
  ...
  gPad->SetBottomMargin(0.20);
  hthtSmeC->SetStats(0);
  hthtSmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  hthtSmeC->GetXaxis()->SetTitle("Four-Momentum Transfer, -t (GeV^{2})"); // Replace with your exact X-variable name
  hthtSmeC->GetXaxis()->CenterTitle(true);
  
  hthtSmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  hthtSmeC->GetXaxis()->SetTitleFont(133);
  hthtSmeC->GetYaxis()->SetLabelFont(133);
  hthtSmeC->GetXaxis()->SetLabelFont(133);
  
  hthtSmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  hthtSmeC->GetXaxis()->SetTitleSize(15);
  hthtSmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  hthtSmeC->GetXaxis()->SetLabelSize(14);
  
  hthtSmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  hthtSmeC->GetXaxis()->SetTitleOffset(2.5);
  ...
  hthepSmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  hthepSmeC->GetXaxis()->SetTitle("Virtual Photon Polarization, #epsilon"); // Replace with your exact X-variable name
  hthepSmeC->GetXaxis()->CenterTitle(true);
  
  hthepSmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  hthepSmeC->GetXaxis()->SetTitleFont(133);
  hthepSmeC->GetYaxis()->SetLabelFont(133);
  hthepSmeC->GetXaxis()->SetLabelFont(133);
  
  hthepSmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  hthepSmeC->GetXaxis()->SetTitleSize(15);
  hthepSmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  hthepSmeC->GetXaxis()->SetLabelSize(14);
  
  hthepSmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  hthepSmeC->GetXaxis()->SetTitleOffset(2.5);
  ...
  gPad->SetBottomMargin(0.20);
  hphmeSC->SetStats(0);
  hphmeSC->GetYaxis()->SetTitle("Yield (Events/mC)");
  hphmeSC->GetXaxis()->SetTitle("Azimuthal Angle, #phi (deg)"); // Replace with your exact X-variable name
  hphmeSC->GetXaxis()->CenterTitle(true);
  
  hphmeSC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  hphmeSC->GetXaxis()->SetTitleFont(133);
  hphmeSC->GetYaxis()->SetLabelFont(133);
  hphmeSC->GetXaxis()->SetLabelFont(133);
  
  hphmeSC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  hphmeSC->GetXaxis()->SetTitleSize(15);
  hphmeSC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  hphmeSC->GetXaxis()->SetLabelSize(14);
  
  hphmeSC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  hphmeSC->GetXaxis()->SetTitleOffset(2.5);  

  hphmeSC->SetStats(0);
  hphmeSC->SetLineColor(kRed);
  hphmeSC->Scale(SSmeC);
  hphmeSC->Draw("hist");
  hphmeC->Add(hphmeCR, -1);
  hphmeC->Scale(ECMEC);
  hphmedC->Add(hphmedCR, -1);
  hphmedC->Scale(ECMEDC);
  hphmeC->Add(hphmedC, -1);
  hphmeC->SetStats(0);
  hphmeC->Draw("same");
...
// =========================================================================
gROOT->SetBatch(kTRUE); // Suppress window pop-ups during processing
TStyle *prlStyle = new TStyle("prlStyle", "PRL Publication Style");

// White background canvases and pads
prlStyle->SetCanvasColor(kWhite);
prlStyle->SetPadColor(kWhite);
prlStyle->SetFrameFillColor(kWhite);
prlStyle->SetCanvasBorderMode(0);
prlStyle->SetPadBorderMode(0);
prlStyle->SetFrameBorderMode(0);

// Default high-density margins 
prlStyle->SetPadLeftMargin(0.15);  // Gives ample breathing room for "Yield (Events/mC)"
prlStyle->SetPadRightMargin(0.04);
//prlStyle->SetPadTopMargin(0.08);   // Clearance room for panel index markers (a, b, c...)
//prlStyle->SetPadBottomMargin(0.20);

// Font Remapping: Font code 132 represents Times New Roman
int font_type = 132;
prlStyle->SetTextFont(font_type);
prlStyle->SetLabelFont(font_type, "XYZ");
prlStyle->SetTitleFont(font_type, "XYZ");

// Publication text scaling and positioning offsets
prlStyle->SetLabelSize(0.05, "XYZ");
prlStyle->SetTitleSize(0.06, "XYZ");
prlStyle->SetTitleOffset(1.20, "Y"); // Prevents label crushing against tick numbers
prlStyle->SetTitleOffset(2.05, "X");

// APS Standard: Inward pointing tick marks framing all four canvas corridors
prlStyle->SetPadTickX(1);
prlStyle->SetPadTickY(1);

// Hide default text banners (captions belong in your LaTeX file instead)
prlStyle->SetOptTitle(0);
prlStyle->SetOptStat(0);

gROOT->SetStyle("prlStyle");
gROOT->ForceStyle();
...
// TCanvas *cthesisAcc = new TCanvas("cthesisAcc", "cthesisAcc", 900, 1800);

 TCanvas *cthesisAcc = new TCanvas("cthesisAcc", "cthesisAcc");                                                                                                             
cthesisAcc->Divide(2, 3, 0.005, 0.005); // Sets explicit tight margins between pads                                                                                                                                                     
// TCanvas *cthesisAcc = new TCanvas("cthesisAcc", "cthesisAcc");
//  cthesisAcc->Divide(2,3);
  ...
  //H_ssdelta_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  H_ssdelta_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  H_ssdelta_SmeC->GetXaxis()->SetTitle("Pion Momentum Fraction (%)"); // Replace with your exact X-variable name
  H_ssdelta_SmeC->GetXaxis()->CenterTitle(true);
  
  H_ssdelta_SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  H_ssdelta_SmeC->GetXaxis()->SetTitleFont(133);
  H_ssdelta_SmeC->GetYaxis()->SetLabelFont(133);
  H_ssdelta_SmeC->GetXaxis()->SetLabelFont(133);
  
  H_ssdelta_SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  H_ssdelta_SmeC->GetXaxis()->SetTitleSize(15);
  H_ssdelta_SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  H_ssdelta_SmeC->GetXaxis()->SetLabelSize(14);
  
  H_ssdelta_SmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  H_ssdelta_SmeC->GetXaxis()->SetTitleOffset(2.5);
  
  H_ssdelta_SmeC->SetLineColor(kRed);
  H_ssdelta_SmeC->Scale(SSmeC);
  H_ssdelta_SmeC->SetMaximum(H_ssdelta_SmeC->GetMaximum() * 1.1);
  ...
  H_ssxptar_SmeC->SetStats(0);
  H_ssxptar_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssxptar_SmeC->GetXaxis()->SetTitle("Pion out-of-plane Angle at Target (rad)"); // Replace with your exact X-variable name
  H_ssxptar_SmeC->GetXaxis()->CenterTitle(true);
  
  H_ssxptar_SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  H_ssxptar_SmeC->GetXaxis()->SetTitleFont(133);
  H_ssxptar_SmeC->GetYaxis()->SetLabelFont(133);
  H_ssxptar_SmeC->GetXaxis()->SetLabelFont(133);
  
  H_ssxptar_SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  H_ssxptar_SmeC->GetXaxis()->SetTitleSize(15);
  H_ssxptar_SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  H_ssxptar_SmeC->GetXaxis()->SetLabelSize(14);
  
  H_ssxptar_SmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  H_ssxptar_SmeC->GetXaxis()->SetTitleOffset(2.5);
  
  H_ssxptar_SmeC->SetLineColor(kRed);
  H_ssxptar_SmeC->Scale(SSmeC);
  ...
  H_ssyptar_SmeC->SetStats(0);
  H_ssyptar_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssyptar_SmeC->GetXaxis()->SetTitle("Pion in-plane Angle at Target (rad)"); // Replace with your exact X-variable name
  H_ssyptar_SmeC->GetXaxis()->CenterTitle(true);
  
  H_ssyptar_SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  H_ssyptar_SmeC->GetXaxis()->SetTitleFont(133);
  H_ssyptar_SmeC->GetYaxis()->SetLabelFont(133);
  H_ssyptar_SmeC->GetXaxis()->SetLabelFont(133);
  
  H_ssyptar_SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  H_ssyptar_SmeC->GetXaxis()->SetTitleSize(15);
  H_ssyptar_SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  H_ssyptar_SmeC->GetXaxis()->SetLabelSize(14);
  
  H_ssyptar_SmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  H_ssyptar_SmeC->GetXaxis()->SetTitleOffset(2.5);

  H_ssyptar_SmeC->SetLineColor(kRed);
  H_ssyptar_SmeC->Scale(SSmeC);
  ...
  H_hsdelta_SmeC->SetStats(0);
  H_hsdelta_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsdelta_SmeC->GetXaxis()->SetTitle("Electron Momentum Fraction (%)"); // Replace with your exact X-variable name
  H_hsdelta_SmeC->GetXaxis()->CenterTitle(true);
  
  H_hsdelta_SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  H_hsdelta_SmeC->GetXaxis()->SetTitleFont(133);
  H_hsdelta_SmeC->GetYaxis()->SetLabelFont(133);
  H_hsdelta_SmeC->GetXaxis()->SetLabelFont(133);
  
  H_hsdelta_SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  H_hsdelta_SmeC->GetXaxis()->SetTitleSize(15);
  H_hsdelta_SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  H_hsdelta_SmeC->GetXaxis()->SetLabelSize(14);
  
  H_hsdelta_SmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  H_hsdelta_SmeC->GetXaxis()->SetTitleOffset(2.5);

  H_hsdelta_SmeC->SetLineColor(kRed);
  H_hsdelta_SmeC->Scale(SSmeC);
  ...
  H_hsxptar_SmeC->SetStats(0);
  H_hsxptar_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsxptar_SmeC->GetXaxis()->SetTitle("Electron out-of-plane Angle at Target (rad)"); // Replace with your exact X-variable name
  H_hsxptar_SmeC->GetXaxis()->CenterTitle(true);
  
  H_hsxptar_SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  H_hsxptar_SmeC->GetXaxis()->SetTitleFont(133);
  H_hsxptar_SmeC->GetYaxis()->SetLabelFont(133);
  H_hsxptar_SmeC->GetXaxis()->SetLabelFont(133);
  
  H_hsxptar_SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  H_hsxptar_SmeC->GetXaxis()->SetTitleSize(15);
  H_hsxptar_SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  H_hsxptar_SmeC->GetXaxis()->SetLabelSize(14);
  
  H_hsxptar_SmeC->GetYaxis()->SetTitleOffset(1.6); // Pushes the large Y-title leftward away from overlap
  H_hsxptar_SmeC->GetXaxis()->SetTitleOffset(2.5);

  H_hsxptar_SmeC->SetLineColor(kRed);
  H_hsxptar_SmeC->Scale(SSmeC);
  ...
  H_hsyptar_SmeC->SetStats(0);
  H_hsyptar_SmeC->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsyptar_SmeC->GetXaxis()->SetTitle("Electron in-plane Angle at Target (rad)"); // Replace with your exact X-variable name
  H_hsyptar_SmeC->GetXaxis()->CenterTitle(true);
  
  H_hsyptar_SmeC->GetYaxis()->SetTitleFont(133); // 133 = Times New Roman absolute pixel mode
  H_hsyptar_SmeC->GetXaxis()->SetTitleFont(133);
  H_hsyptar_SmeC->GetYaxis()->SetLabelFont(133);
  H_hsyptar_SmeC->GetXaxis()->SetLabelFont(133);
  
  H_hsyptar_SmeC->GetYaxis()->SetTitleSize(15);  // Forces title height to exactly 24 pixels
  H_hsyptar_SmeC->GetXaxis()->SetTitleSize(15);
  H_hsyptar_SmeC->GetYaxis()->SetLabelSize(14);  // Forces label number height to exactly 18 pixels
  H_hsyptar_SmeC->GetXaxis()->SetLabelSize(14);
  
  H_hsyptar_SmeC->GetYaxis()->SetTitleOffset(2.0); // Pushes the large Y-title leftward away from overlap
  H_hsyptar_SmeC->GetXaxis()->SetTitleOffset(2.5);

  H_hsyptar_SmeC->SetLineColor(kRed);
  H_hsyptar_SmeC->Scale(SSmeC);
  ...
  cthesisme1->cd(1);
  hthtmeR2->Add(hthtmeR2R, -1);
  hthtmeR2->Scale(ECMER2);
  hthtmedR2->Add(hthtmedR2R, -1);
  hthtmedR2->Scale(ECMEDR2);
  hthtmeR2->Add(hthtmedR2, -1);
  hthtSmeR2->SetStats(0);
  hthtSmeR2->SetLineColor(kRed);
  hthtSmeR2->Scale(SSmeR2);
  hthtSmeR2->Draw("hist");
  hthtmeR2->SetStats(0);
  hthtmeR2->Draw("same");

  cthesisme1->cd(2);
  hthtmeR1->Add(hthtmeR1R, -1);
  hthtmeR1->Scale(ECMER1);
  hthtmedR1->Add(hthtmedR1R, -1);
  hthtmedR1->Scale(ECMEDR1);
  hthtmeR1->Add(hthtmedR1, -1);
  hthtSmeR1->SetStats(0);
  hthtSmeR1->SetLineColor(kRed);
  hthtSmeR1->Scale(SSmeR1);
  hthtSmeR1->Draw("hist");
  hthtmeR1->SetStats(0);
  hthtmeR1->Draw("same");
  ...
  */
  ...
  hYSheL1->Sumw2();
  hYSheL2->Sumw2();
  TH2D *hYSheR1err   = new TH2D("hYSheR1err"," Yield SIMC R1;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSheCerr    = new TH2D("hYSheCerr"," Yield SIMC C;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSheL1err   = new TH2D("hYSheL1err"," Yield SIMC L1;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  TH2D *hYSheL2err   = new TH2D("hYSheL2err"," Yield SIMC L2;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  ...
  */
  ...
  Double_t tOffsetheC = 0.00;
  Double_t tOffsetheL1 = 0.00;
  Double_t tOffsetheL2 = 0.00;
  */
  // Garth Number April 06, 26
  Double_t tOffsetheR1 = 0.00027;
  Double_t tOffsetheC = 0.00046;
  Double_t tOffsetheL1 = 0.00056;
  Double_t tOffsetheL2 = 0.00069;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHER1; i++)
	...
	htcoinheR1->Fill(tcoinheR1-TimmingOffset);
      ...
      Double_t CoinPionR1 = tcoinheR1-TimmingOffset>=-1.0-COINCUTDEP && tcoinheR1-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPionR1 && MMpiR1 && DiamondR1)
	{
	  ...
	  hththeR1->Fill(-theR1+tOffsetheR1);
	  htheR1->Fill(-theR1);
	  htheInR1->Fill(-theR1);
	  ...
	  hYheR1->Fill(-theR1+tOffsetheR1, std::fmod(ph_qheR1 * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPionR1R && MMpiR1 && DiamondR1)
	{
	  ...
	  hththeR1R->Fill(-theR1+tOffsetheR1);
	  htheR1R->Fill(-theR1);
	  ...
	  hYheR1R->Fill(-theR1+tOffsetheR1, std::fmod(ph_qheR1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDR1; i++)
    {
      ...
      Double_t CoinPiondR1 = tcoinhedR1-TimmingOffset>=-1.0-COINCUTDEP && tcoinhedR1-TimmingOffset <= 1.0+COINCUTDEP;      
	...
	{
	  hYhedR1->Fill(-thedR1+tOffsetheR1, std::fmod(ph_qhedR1 * 180.0 / TMath::Pi() + 360.0,360.0));
	...
	{
	  hYhedR1R->Fill(-thedR1+tOffsetheR1, std::fmod(ph_qhedR1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC RIGHT1                                                                                                                                                                                      
  Double_t normfacheR1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_right1.hist");
  Double_t NFR1 = normfacheR1/400000.0;
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHER1; i++)

    {
      ...
      //      Double_t NFR1 = 35368100/400000.0;
      //Double_t NFR1 = 35964000/400000.0;
      // Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_right1.hist");
      //Double_t NFR1 = normfac/400000.0;

      // Double_t NFR1 = 35937500/400000.0;
      //RadiativeStudy
      //Double_t NFR1 = 39332000.0/400000.0;
      ...
      if(CUTSIMCHER12)	
	{
	  ...
	  hYSheR1err->Fill(t_simcheR1,phipqheR1*57.2958);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEC; i++)
	...
	htcoinheC->Fill(tcoinheC-TimmingOffset);
      ...
      Double_t CoinPionC = tcoinheC-TimmingOffset>=-1.0-COINCUTDEP && tcoinheC-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPionCR && DiamondC)
	{
	  ...
	  hYheCR->Fill(-theC+tOffsetheC, std::fmod(ph_qheC * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDC; i++)
    {
      ...
      Double_t CoinPiondC = tcoinhedC-TimmingOffset>=-1.0-COINCUTDEP && tcoinhedC-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPiondC && DiamonddC)
	{
      ...
      if(CoinPiondC && MMpidC && DiamonddC)
	{
	  hYhedC->Fill(-thedC+tOffsetheC, std::fmod(ph_qhedC * 180.0 / TMath::Pi() + 360.0,360.0));
	  //hYhedC->Fill(-thedC, mmhedC+MMpiOffsetheC);
	  hththedC->Fill(-thedC+tOffsetheC);
      ...
      if(CoinPiondCR && DiamonddC)
	{
      ...
      if(CoinPiondCR && MMpidC && DiamonddC)
	{
	  hYhedCR->Fill(-thedC, std::fmod(ph_qheC * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC CENTER                                                                                                                                                                                      
  Double_t normfacheC = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_center.hist");
  Double_t NFC = normfacheC/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEC; i++)

    {
      ...
      //      Double_t NFC = 35272600/400000.0;
      //Double_t NFC = 36314600/400000.0;
      //Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_center.hist");
      //Double_t NFC = normfac/400000.0;

      //   Double_t NFC = 36263100/400000.0;
      //RadiativeStudy
      //Double_t NFC = 39441300.0/400000.0;
      ...
      if (CUTSIMCHEC)
	{
	  ...
	  hYSheCerr->Fill(t_simcheC,phipqheC*57.2958);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEL1; i++)
	...
	htcoinheL1->Fill(tcoinheL1-TimmingOffset);
      ...
      Double_t CoinPionL1 = tcoinheL1-TimmingOffset>=-1.0-COINCUTDEP && tcoinheL1-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  hYheL1->Fill(-theL1+tOffsetheL1, std::fmod(ph_qheL1 * 180.0 / TMath::Pi() + 360.0,360.0));
 	...
 	
	{
	  ...
	  hYheL1R->Fill(-theL1+tOffsetheL1, std::fmod(ph_qheL1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDL1; i++)
    {
      ...
      Double_t CoinPiondL1 = tcoinhedL1-TimmingOffset>=-1.0-COINCUTDEP && tcoinhedL1-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPiondL1 && DiamonddL1)
	{
      ...
      if(CoinPiondL1 && MMpidL1 && DiamonddL1)
	{
	  hYhedL1->Fill(-thedL1+tOffsetheL1, std::fmod(ph_qhedL1 * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPiondL1R && DiamonddL1)
	{
      ...
      if(CoinPiondL1R && MMpidL1 && DiamonddL1)
	{
	  hYhedL1R->Fill(-thedL1+tOffsetheL1, std::fmod(ph_qhedL1 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC LEFT1                                                                                                                                                                                      
  Double_t normfacheL1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_left1.hist");
  Double_t NFL1 = normfacheL1/400000.0;
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEL1; i++)

    {
      ...
      //      Double_t NFL1 = 35032400/400000.0;
      //Double_t NFL1 = 36515400/400000.0;
      //Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_left1.hist");
      //Double_t NFL1 = normfac/400000.0;

      //     Double_t NFL1 = 36433000/400000.0;
      //RadiativeStudy
      //Double_t NFL1 = 39506000.0/400000.0;
      ...
      if(CUTSIMCHEL12)
	{
	  ...
	  hYSheL1err->Fill(t_simcheL1,phipqheL1*57.2958);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEL2; i++)
	...
	htcoinheL2->Fill(tcoinheL2-TimmingOffset);
      ...
      Double_t CoinPionL2 = tcoinheL2-TimmingOffset>=-1.0-COINCUTDEP && tcoinheL2-TimmingOffset <= 1.0+COINCUTDEP;      
  ...
  
	{
	  ...
	  hYheL2->Fill(-theL2+tOffsetheL2, std::fmod(ph_qheL2 * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPionL2R && MMpiL2 && DiamondL2)
	{
	  ...
	  hYheL2R->Fill(-theL2+tOffsetheL2, std::fmod(ph_qheL2 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDL2; i++)
    {
      ...
      Double_t CoinPiondL2 = tcoinhedL2-TimmingOffset>=-1.0-COINCUTDEP && tcoinhedL2-TimmingOffset <= 1.0+COINCUTDEP;      
      ...
      if(CoinPiondL2 && DiamonddL2)
	{
      ...
      if(CoinPiondL2 && MMpidL2 && DiamonddL2)
	{
	  hYhedL2->Fill(-thedL2+tOffsetheL2, std::fmod(ph_qhedL2 * 180.0 / TMath::Pi() + 360.0,360.0));
      ...
      if(CoinPiondL2R && MMpidL2 && DiamonddL2)
	{
      ...
      if(CoinPiondL2R && MMpidL2 && DiamonddL2)
	{
	  hYhedL2R->Fill(-thedL2+tOffsetheL2, std::fmod(ph_qhedL2 * 180.0 / TMath::Pi() + 360.0,360.0));
  ...
  //SIMC LEFT2                                                                                                                                                                                      
  Double_t normfacheL2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_left2.hist");
  Double_t NFL2 = normfacheL2/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEL2; i++)

    {
      ...
      // Double_t NFL2 = 34569000/400000.0;
      //Double_t NFL2 = 36487100/400000.0;
      // Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q1_left2.hist");
      // Double_t NFL2 = normfac/400000.0;

      //      Double_t NFL2 = 36333400/400000.0;
      //RadiativeStudy
      //Double_t NFL2 = 39395000.0/400000.0;
      ...
      if(CUTSIMCHEL2)       
	{
	  ...
	  hYSheL2err->Fill(t_simcheL2,phipqheL2*57.2958);
  ...
  */
  Double_t ECHER1   = 1.0/108.35994621603191;
  Double_t ECHER1err   = 0.4002581246568523;
  Double_t ECHEDR1  = 1.0/40.054299058429294;
  Double_t ECHEDR1err  = 0.09562237779751187;
  /*
  Double_t ECHEC    = 1.0/286.61148000000003;
  Double_t ECHEDC   = 1.0/62.482;
  */
  Double_t ECHEC    = 1.0/259.9532120484441;
  Double_t ECHECerr    = 2.5817504722507563;
  Double_t ECHEDC   = 1.0/56.67042935112795;
  Double_t ECHEDCerr   = 0.07268725605978202;
  /*
  Double_t ECHEL1   = 1.0/162.69519;
  Double_t ECHEDL1  = 1.0/25.9835;
  */
  Double_t ECHEL1   = 1.0/147.56266306102472;
  Double_t ECHEL1err   = 0.6838607386546828;
  Double_t ECHEDL1  = 1.0/23.566752184080567;
  Double_t ECHEDL1err  = 0.0223426467516774;
  /*
  Double_t ECHEL2   = 1.0/165.6892;
  Double_t ECHEDL2  = 1.0/70.1662;
  */
  Double_t ECHEL2   = 1.0/150.27814706859084;
  Double_t ECHEL2err   = 1.0198617441109998;
  Double_t ECHEDL2  = 1.0/63.63995788621499;
  Double_t ECHEDL2err  = 0.04976450504442071;
  //SIMC SCAL
  ...
  TAxis *XmpiheR1 = MPiheR1->GetXaxis();
  Double_t InmpiheR1 = MPiheR1->Integral(XmpiheR1->FindBin(MMPICUTL), XmpiheR1->FindBin(MMPICUTH), "");
  TAxis *XmpiSheR1 = MPiSheR1->GetXaxis();
  Double_t InmpiSheR1 = MPiSheR1->Integral(XmpiSheR1->FindBin(MMPICUTL), XmpiSheR1->FindBin(MMPICUTH), "");
  Double_t SSheR1 = InmpiheR1/InmpiSheR1; 
  MPiSheR1->SetStats(0);
  MPiSheR1->SetLineColor(kRed);
  MPiSheR1->Scale(SSheR1);  
  MPiSheR1->SetStats(0);
  MPiSheR1->SetLineColor(kRed);
  MPiSheR1->Draw("hist");
  MPiheR1->SetStats(0);
  ...
  TAxis *XmpiheC = MPiheC->GetXaxis();
  Double_t InmpiheC = MPiheC->Integral(XmpiheC->FindBin(MMPICUTL), XmpiheC->FindBin(MMPICUTH), "");
  TAxis *XmpiSheC = MPiSheC->GetXaxis();
  Double_t InmpiSheC = MPiSheC->Integral(XmpiSheC->FindBin(MMPICUTL), XmpiSheC->FindBin(MMPICUTH), "");
  Double_t SSheC = InmpiheC/InmpiSheC; 
  MPiSheC->SetStats(0);
  ...
  TAxis *XmpiheL1 = MPiheL1->GetXaxis();
  Double_t InmpiheL1 = MPiheL1->Integral(XmpiheL1->FindBin(MMPICUTL), XmpiheL1->FindBin(MMPICUTH), "");
  TAxis *XmpiSheL1 = MPiSheL1->GetXaxis();
  Double_t InmpiSheL1 = MPiSheL1->Integral(XmpiSheL1->FindBin(MMPICUTL), XmpiSheL1->FindBin(MMPICUTH), "");
  Double_t SSheL1 = InmpiheL1/InmpiSheL1; 
  MPiSheL1->SetStats(0);
  MPiSheL1->SetLineColor(kRed);
  MPiSheL1->Scale(SSheL1);  
  MPiSheL1->SetStats(0);
  MPiSheL1->SetLineColor(kRed);
  MPiSheL1->Draw("hist");
  MPiheL1->SetStats(0);
  ...
  TAxis *XmpiheL2 = MPiheL2->GetXaxis();
  Double_t InmpiheL2 = MPiheL2->Integral(XmpiheL2->FindBin(MMPICUTL), XmpiheL2->FindBin(MMPICUTH), "");
  TAxis *XmpiSheL2 = MPiSheL2->GetXaxis();
  Double_t InmpiSheL2 = MPiSheL2->Integral(XmpiSheL2->FindBin(MMPICUTL), XmpiSheL2->FindBin(MMPICUTH), "");
  Double_t SSheL2 = InmpiheL2/InmpiSheL2; 
  MPiSheL2->SetStats(0);
  MPiSheL2->SetLineColor(kRed);
  MPiSheL2->Scale(SSheL2);  
  MPiSheL2->SetStats(0);
  MPiSheL2->SetLineColor(kRed);
  MPiSheL2->Draw("hist");
  MPiheL2->SetStats(0);
  ...
  **/
  ...
  hphheC->Scale(ECHEC);
  hphheC->Draw("same");
  //Phi binning lines for ppt plot
  Double_t phiheCYmin = 0.0;
  Double_t phiheCYmax = 13.0;
  TLine *phiheCl0 = new TLine(0.0, phiheCYmin, 0.0, phiheCYmax);
  TLine *phiheCl1 = new TLine(22.5, phiheCYmin, 22.5, phiheCYmax);
  TLine *phiheCl2 = new TLine(45.0, phiheCYmin, 45.0, phiheCYmax);
  TLine *phiheCl3 = new TLine(67.5, phiheCYmin, 67.5, phiheCYmax);
  TLine *phiheCl4 = new TLine(90.0, phiheCYmin, 90.0, phiheCYmax);
  TLine *phiheCl5 = new TLine(112.5, phiheCYmin,112.5, phiheCYmax);
  TLine *phiheCl6 = new TLine(135.0, phiheCYmin, 135.0, phiheCYmax);
  TLine *phiheCl7 = new TLine(157.5, phiheCYmin, 157.5, phiheCYmax);
  TLine *phiheCl8 = new TLine(180.0, phiheCYmin, 180.0, phiheCYmax);
  TLine *phiheCl9 = new TLine(202.5, phiheCYmin, 202.5, phiheCYmax);
  TLine *phiheCl10 = new TLine(225.0, phiheCYmin, 225.0, phiheCYmax);
  TLine *phiheCl11 = new TLine(247.5, phiheCYmin, 247.5, phiheCYmax);
  TLine *phiheCl12 = new TLine(270.0, phiheCYmin, 270.0, phiheCYmax);
  TLine *phiheCl13 = new TLine(292.5, phiheCYmin, 292.5, phiheCYmax);
  TLine *phiheCl14 = new TLine(315.0, phiheCYmin, 315.0, phiheCYmax);
  TLine *phiheCl15 = new TLine(337.5, phiheCYmin, 337.5, phiheCYmax);
  TLine *phiheCl16 = new TLine(360, phiheCYmin, 360, phiheCYmax);
  phiheCl0->SetLineColor(kBlack);
  phiheCl1->SetLineColor(kBlack);
  phiheCl2->SetLineColor(kBlack);
  phiheCl3->SetLineColor(kBlack);
  phiheCl4->SetLineColor(kBlack);
  phiheCl5->SetLineColor(kBlack);
  phiheCl6->SetLineColor(kBlack);
  phiheCl7->SetLineColor(kBlack);
  phiheCl8->SetLineColor(kBlack);
  phiheCl9->SetLineColor(kBlack);
  phiheCl10->SetLineColor(kBlack);
  phiheCl11->SetLineColor(kBlack);
  phiheCl12->SetLineColor(kBlack);
  phiheCl13->SetLineColor(kBlack);
  phiheCl14->SetLineColor(kBlack);
  phiheCl15->SetLineColor(kBlack);
  phiheCl16->SetLineColor(kBlack);
  phiheCl0->Draw("same");
  phiheCl1->Draw("same");
  phiheCl2->Draw("same");
  phiheCl3->Draw("same");
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYheR1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHER1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHER1err*ECHER1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YheR1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YheR1.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYhedR1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEDR1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEDR1err*ECHEDR1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdheR1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdheR1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSheR1err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSheR1->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSheR1<<hYSheR1->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSheR1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYheC->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEC;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHECerr*ECHEC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YheC<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YheC.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYhedC->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEDC;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEDCerr*ECHEDC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	    }
	  YdheC<< Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdheC.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSheCerr->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSheC->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSheC<<hYSheC->IntegralAndError(j, j, i, i, err, "")<<"\t"<< Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSheC.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYheL1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEL1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEL1err*ECHEL1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YheL1<<Yield<<"\t"<< YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YheL1.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYhedL1->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEDL1;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEDL1err*ECHEDL1),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YdheL1<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdheL1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSheL1err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSheL1->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	  ...
	  YSheL1<<hYSheL1->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSheL1.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYheL2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEL2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEL2err*ECHEL2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YheL2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YheL2.close();
  //Dummy
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYhedL2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEDL2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEDL2err*ECHEDL2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
	    {
	      Yield = 0.0; 
	      YieldErr = 0;
	  ...
	  YdheL2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YdheL2.close();
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
	  Double_t err2;
	  Double_t TotNoEvent = hYSheL2err->IntegralAndError(j, j, i, i, err1, "");	  
	  Double_t Y = hYSheL2->IntegralAndError(j, j, i, i, err2, "");	  
	  Double_t Yerr = Y/sqrt(TotNoEvent);
	  if (TotNoEvent <= 0)
	    {
	      Yerr = 0;
	    }
	  YSheL2<<hYSheL2->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;	  
	}
    } 
  YSheL2.close();
  ...
  hQ2WSC->GetListOfFunctions()->Add(Dcut,"L");
  hQ2WSC->Write();
  hQ2WSC->GetListOfFunctions()->Clear("L");
  OutHisto_file->Close();
  ...
  **/
  ...
  TLine *fstedgel = new TLine(0.00595, Ymin, 0.00595, Ymax);
  ...
  TLine *lastedgel = new TLine(0.06, Ymin, 0.06, Ymax);
  ...
  TLine *lt1  = new TLine(0.0118167, Ymin, 0.0118167, Ymax);
  ...
  TLine *lt2  = new TLine(0.0156167, Ymin, 0.0156167, Ymax);
  ...
  TLine *lt3  = new TLine(0.02515, Ymin, 0.02515, Ymax);
  ...
  TLine *lt4  = new TLine(0.03455, Ymin, 0.03455, Ymax);
  ...
  TLine *lt5  = new TLine(0.0406833, Ymin, 0.0406833, Ymax);
  ...
  TLine *lt6  = new TLine(0.05465, Ymin, 0.05465, Ymax);
  ...
  */
  ...
  legt->SetHeader("All epsilon at Q2 = 0.375 GeV2","C");
 ...
 // Add common axis title and labels
  ...
  //VK, April 15, 2026
  /*
  TCanvas *c1PRL = new TCanvas("c1PRL","PRL Histogram",800,600);
  c1PRL->SetFillColor(0);
  c1PRL->SetBorderMode(0);
  c1PRL->SetFrameBorderMode(0);
  
  c1PRL->SetLeftMargin(0.14);
  c1PRL->SetBottomMargin(0.14);
  c1PRL->SetRightMargin(0.04);
  c1PRL->SetTopMargin(0.05);
  htcoinmeC->SetStats(0);
  htcoinmeC->SetLineWidth(2);
  //  htcoinmeC->SetFillColor(0);
  // htcoinmeC->SetMarkerStyle(20);
  htcoinmeC->SetMarkerSize(0.8);
  htcoinmeC->GetXaxis()->SetTitle("Coincidence Time Between Spectrometers (ns)");
  htcoinmeC->GetYaxis()->SetTitle("Yield (Events/mC)");
  htcoinmeC->GetXaxis()->CenterTitle();
  htcoinmeC->GetYaxis()->CenterTitle();
  htcoinmeC->GetXaxis()->SetTitleSize(0.050);
  htcoinmeC->GetYaxis()->SetTitleSize(0.050);
  htcoinmeC->GetXaxis()->SetLabelSize(0.045);
  htcoinmeC->GetYaxis()->SetLabelSize(0.045);
  htcoinmeC->GetXaxis()->SetTitleOffset(1.10);
  htcoinmeC->GetYaxis()->SetTitleOffset(1.35);
  htcoinmeC->GetXaxis()->SetNdivisions(505);
  htcoinmeC->GetYaxis()->SetNdivisions(505);
  htcoinmeC->SetMinimum(0.0);
  htcoinmeC->Draw("Weight");
  htcoinmeL1->Draw("same Weight");
  htcoinmeL2->Draw("same Weight");
  htcoinmeR1->Draw("same Weight");
  ...
  l6me->Draw("same");
  legme->Draw("same");
  c1PRL->SaveAs("prl_coin.pdf");
  c1PRL->SaveAs("prl_coin.eps");
  */
   //The End......
