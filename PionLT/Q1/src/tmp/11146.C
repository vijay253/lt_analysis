...
void Q1Analysis()
{
  ...
  // Double_t SIMC_Delta_Low_H   = -7.76;
  // Double_t SIMC_Delta_High_H  =  7.76;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHDL1; i++)
    {
      ...
      Double_t MMpidL1 = mmdL1>= MMPICUTL && mmdL1 <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHDL2; i++)
    {
      ...
      Double_t MMpidL2 = mmdL2>= MMPICUTL && mmdL2 <=MMPICUTH;
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDER1; i++)
	...
	htcoinmeR1->Fill(tcoinmeR1-TimmingOffset);
      ...
      Double_t MMpiR1 = mmmeR1>=MMPICUTL && mmmeR1<=MMPICUTH;
      ...
      if(CoinPionR1 && MMpiR1 && DiamondR1)
	{
	  ...
	  //hYmeR1->Fill(-tmeR1, mmmeR1);
	}
      //Random
      if(CoinPionR1R && DiamondR1)
	{
	  MPimeR1R->Fill(mmmeR1);
	}
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDR1; i++)
    {
      ...
      Double_t MMpidR1 = mmmedR1>=MMPICUTL && mmmedR1<=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDER2; i++)
	...
	htcoinmeR2->Fill(tcoinmeR2-TimmingOffset);
      ...
      Double_t MMpiR2 = mmmeR2>=MMPICUTL && mmmeR2 <=MMPICUTH;
      ...
      if(CoinPionR2 && MMpiR2 && DiamondR2)
	{
	  ...
	  //hYmeR2->Fill(-tmeR2, mmmeR2);
	}
      //Random
      if(CoinPionR2R && DiamondR2)
	{
	  MPimeR2R->Fill(mmmeR2);
	}
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDR2; i++)
    {
      ...
      Double_t MMpidR2 = mmmedR2>=MMPICUTL && mmmedR2<=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEC; i++)

    {
      ...
      if(tcoinmeC-TimmingOffset>=-1.0 && tcoinmeC-TimmingOffset <= 1.0 && mmmeC>= 0.932 && mmmeC <=0.98)
	{
	...
	htcoinmeC->Fill(tcoinmeC-TimmingOffset);
      ...
      //      Double_t MMpiC = mmmeC>= 0.932  && mmmeC <=0.98;
      Double_t MMpiC = mmmeC>=MMPICUTL && mmmeC <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDC; i++)
    {
      ...
      Double_t MMpidC = mmmedC>=MMPICUTL && mmmedC <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEL1; i++)
	...
	htcoinmeL1->Fill(tcoinmeL1-TimmingOffset);
      ...
      Double_t MMpiL1 = mmmeL1>=MMPICUTL && mmmeL1 <=MMPICUTH;
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  //hYmeL1->Fill(-tmeL1, mmmeL1);

	}
      //Random
      if(CoinPionL1R && MMpiL1 && DiamondL1) 	
	{
	  MPimeL1R->Fill(mmmeL1);
	}
      if(CoinPionL1R && MMpiL1 && DiamondL1) 	
	{
	  ...
	  hphmeL1R->Fill(ph_qmeL1*57.2958 + 180);
 	  //hphmeL1R->Fill(mmmeL1);
	  hYmeL1R->Fill(-tmeL1, ph_qmeL1*57.2958 + 180);
	  //hYmeL1R->Fill(-tmeL1, mmmeL1);
	}
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDL1; i++)
    {
      ...
      Double_t MMpidL1 = mmmedL1>=MMPICUTL && mmmedL1<=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEL2; i++)
	...
	htcoinmeL2->Fill(tcoinmeL2-TimmingOffset);
      ...
      Double_t MMpiL2 = mmmeL2>=MMPICUTL && mmmeL2 <=MMPICUTH;
	...
	
	{
	  ...
	  //hYmeL2->Fill(-tmeL2, mmmeL2);
	}
      //Random
      if(CoinPionL2R && DiamondL2)
	{
	  MPimeL2R->Fill(mmmeL2);
	}
      if(CoinPionL2R && MMpiL2 && DiamondL2)
	{
	  ...
	  hphmeL2R->Fill(ph_qmeL2*57.2958 + 180);
 	  //hphmeL2R->Fill(mmmeL2);
	  hYmeL2R->Fill(-tmeL2, ph_qmeL2*57.2958 + 180);
	  //hYmeL2R->Fill(-tmeL2, mmmeL2);
	}
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEDL2; i++)
    {
      ...
      Double_t MMpidL2 = mmmedL2>=MMPICUTL && mmmedL2 <=MMPICUTH;
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHER1; i++)
	...
	htcoinheR1->Fill(tcoinheR1-TimmingOffset);
      ...
      Double_t MMpiR1 = mmheR1>=MMPICUTL && mmheR1 <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDR1; i++)
    {
      ...
      Double_t MMpidR1 = mmhedR1>=MMPICUTL && mmhedR1 <=MMPICUTH;
	...
	{
	  MPihedR1->Fill(mmhedR1);
	}
      if(CoinPiondR1 && MMpidR1 && DiamonddR1)
	{
	  hYhedR1->Fill(-thedR1, ph_qhedR1*57.2958 + 180);
	  //hYhedR1->Fill(-thedR1, mmhedR1);
	  hththedR1->Fill(-thedR1);
	}
      //Random
      if(CoinPiondR1R && DiamonddR1)
	{
      	  MPihedR1R->Fill(mmhedR1);
	}
      if(CoinPiondR1R && MMpidR1 && DiamonddR1)
	{
	  hYhedR1R->Fill(-thedR1, ph_qhedR1*57.2958 + 180);
	  //hYhedR1R->Fill(-thedR1, mmhedR1);
	  hththedR1R->Fill(-thedR1);
	}      
    }    
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEC; i++)
    
    {
      ...
      if(tcoinheC-TimmingOffset>=-1.0 && tcoinheC-TimmingOffset <= 1.0 && 0.932 && mmheC <=0.98)
	{
	...
	htcoinheC->Fill(tcoinheC-TimmingOffset);
      ...
      Double_t MMpiC = mmheC>=MMPICUTL && mmheC <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDC; i++)
    {
      ...
      Double_t MMpidC = mmhedC>=MMPICUTL && mmhedC <=MMPICUTH;
      ...
      if(CoinPiondC && MMpidC && DiamonddC)
	{
      ...
      if(CoinPiondCR && DiamonddC)
	{
	  MPihedCR->Fill(mmhedC);
	}      
      if(CoinPiondCR && MMpidC && DiamonddC)
	{
	  hYhedCR->Fill(-thedC, ph_qhedR1*57.2958 + 180);
	  //hYhedCR->Fill(-thedC, mmhedC);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEL1; i++)
	...
	htcoinheL1->Fill(tcoinheL1-TimmingOffset);
      ...
      Double_t MMpiL1 = mmheL1>=MMPICUTL && mmheL1 <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDL1; i++)
    {
      ...
      Double_t MMpidL1 = mmhedL1>=MMPICUTL && mmhedL1 <=MMPICUTH;
      ...
      if(CoinPiondL1 && DiamonddL1)
	{
	  MPihedL1->Fill(mmhedL1);
	}
      if(CoinPiondL1 && MMpidL1 && DiamonddL1)
	{
	  hYhedL1->Fill(-thedL1, ph_qhedL1*57.2958 + 180);
	  //hYhedL1->Fill(-thedL1, mmhedL1);
      ...
      if(CoinPiondL1R && DiamonddL1)
	{
	  MPihedL1R->Fill(mmhedL1);
	}
      if(CoinPiondL1R && MMpidL1 && DiamonddL1)
	{
	  hYhedL1R->Fill(-thedL1, ph_qhedL1*57.2958 + 180);
	  //hYhedL1R->Fill(-thedL1, mmhedL1);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEL2; i++)
	...
	htcoinheL2->Fill(tcoinheL2-TimmingOffset);
      ...
      Double_t MMpiL2 = mmheL2>=MMPICUTL && mmheL2 <=MMPICUTH;
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDL2; i++)
    {
      ...
      Double_t MMpidL2 = mmhedL2>=MMPICUTL && mmhedL2 <=MMPICUTH;
      ...
      if(CoinPiondL2 && DiamonddL2)
	{
	  MPihedL2->Fill(mmhedL2);
	}
      if(CoinPiondL2 && MMpidL2 && DiamonddL2)
	{
	  hYhedL2->Fill(-thedL2, ph_qhedL2*57.2958 + 180);
	  //hYhedL2->Fill(-thedL2, mmhedL2);
      ...
      if(CoinPiondL2R && MMpidL2 && DiamonddL2)
	{
	  MPihedL2R->Fill(mmhedL2);
	}
      if(CoinPiondL2R && MMpidL2 && DiamonddL2)
	{
	  hYhedL2R->Fill(-thedL2, ph_qhedL2*57.2958 + 180);
	  //hYhedL2R->Fill(-thedL2, mmhedL2);
