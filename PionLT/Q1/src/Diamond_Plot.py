...
root_files = ["/cache/hallc/kaonlt/vijay/Analysis/Q1/Analysed_Data_Q0p375W2p2_highe_Center.root", "/cache/hallc/kaonlt/vijay/Analysis/Q1/Analysed_Data_Q0p375W2p2_mide_Center.root", "/cache/hallc/kaonlt/vijay/Analysis/Q1/Analysed_Data_Q0p375W2p2_lowe_Center.root"]
...
labels = ["$\epsilon$ = 0.781", "$\epsilon$ = 0.629", "$\epsilon$ = 0.286"]
