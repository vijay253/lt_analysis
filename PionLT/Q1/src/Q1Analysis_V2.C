...
void Q1Analysis_V2()
{
  ...
  //Output file names 
  TString foutname   = OutPath+"/" + "Plots_Qp375W2p2" + ".root";
  TString fouttxt    = OutPath+"/" + "Plots_Qp375W2p2" + ".txt";
  TString outputpdf  = OutPath+"/" + "Plots_Qp375W2p2" + ".pdf";
 ...
 //*************************
  ...
  TH1D *hthQ2dC  = new TH1D("hthQ2dC"," ; Q^{2} (GeV^{2}); Yield (Events/mC)", 150, 0.2, 0.6);
  TH1D *hthWdC   = new TH1D("hthWdC"," ;W (GeV); Yield (Events/mC)", 150, 2.14, 2.26);
  ...
  TH1D *hthQ2dCR  = new TH1D("hthQ2dCR"," ; Q^{2} (GeV^{2}); Yield (Events/mC)", 150, 0.2, 0.6);      
  TH1D *hthWdCR   = new TH1D("hthWdCR"," ;W (GeV); Yield (Events/mC)", 150, 2.14, 2.26);
 ...
 //*************************
  ...
  Double_t bins[] = {-0.01, 0.00595, 0.0118167, 0.0151167, 0.01915, 0.02655, 0.0316833, 0.04565, 0.060, 0.0741167, 0.1};
  ...
  //DATA
  TH1D *hph_qC  = new TH1D("hph_qC","; ph_q;",   18, -22.5, 382.5);      
  TH1D *hph_qL1  = new TH1D("hph_qL1","; ph_q;", 18, -22.5, 382.5);      
  TH1D *hph_qL2  = new TH1D("hph_qL2","; ph_q;", 18, -22.5, 382.5);      

  TH1D *hph_qCR  = new TH1D("hph_qCR","; ph_q;",  18, -22.5, 382.5);      
  TH1D *hph_qL1R  = new TH1D("hph_qL1R","; ph_q;",18, -22.5, 382.5);      
  TH1D *hph_qL2R  = new TH1D("hph_qL2R","; ph_q;",18, -22.5, 382.5);      

  //SIMC
  TH1D *hph_qSC  = new TH1D("hph_qSC","; ph_q;",   18, -22.5, 382.5);      
  TH1D *hph_qSL1  = new TH1D("hph_qSL1","; ph_q;", 18, -22.5, 382.5);      
  TH1D *hph_qSL2  = new TH1D("hph_qSL2","; ph_q;", 18, -22.5, 382.5);      

  TH1D *hmmC  = new TH1D("hmmC","; MM;", 300, 0.8, 1.2);      
  TH1D *hmmL1  = new TH1D("hmmL1","; MM;", 300, 0.8, 1.2);      
  TH1D *hmmL2  = new TH1D("hmmL2","; MM;", 300, 0.8, 1.2);      

  TH1D *hmmCR  = new TH1D("hmmCR","; MM;", 300, 0.8, 1.2);      
  TH1D *hmmL1R  = new TH1D("hmmL1R","; MM;", 300, 0.8, 1.2);      
  TH1D *hmmL2R  = new TH1D("hmmL2R","; MM;", 300, 0.8, 1.2);      
  ...
  //CENTER
  TH1D *hphC  = new TH1D("hphC","; ph_q;",50, -10, 370);      
  TH1D *hphCR  = new TH1D("hphCR","; ph_q;",  50, -10, 370);      
  TH1D *hphSC  = new TH1D("hphSC","; ph_q;",50, -10, 370);      

  TH1D *hthC  = new TH1D("hthC","; th_q;",   50, -0.01, 5.0);      
  TH1D *hthCR  = new TH1D("hthCR","; th_q;",  50, -0.01, 5.0);      
  TH1D *hthSC  = new TH1D("hth_qC","; th_q;",   50, -0.01, 5.0);      

  TH1D *H_ssdelta_SC  = new TH1D("H_ssdelta_SC","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_SC  = new TH1D("H_ssxptar_SC","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_SC  = new TH1D("H_ssyptar_SC","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DC  = new TH1D("H_ssdelta_DC","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DC  = new TH1D("H_ssxptar_DC","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DC  = new TH1D("H_ssyptar_DC","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DCR  = new TH1D("H_ssdelta_DCR","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DCR  = new TH1D("H_ssxptar_DCR","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DCR  = new TH1D("H_ssyptar_DCR","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_hsdelta_SC  = new TH1D("H_hsdelta_SC","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_SC  = new TH1D("H_hsxptar_SC","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_SC  = new TH1D("H_hsyptar_SC","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DC  = new TH1D("H_hsdelta_DC","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DC  = new TH1D("H_hsxptar_DC","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DC  = new TH1D("H_hsyptar_DC","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DCR  = new TH1D("H_hsdelta_DCR","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DCR  = new TH1D("H_hsxptar_DCR","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DCR  = new TH1D("H_hsyptar_DCR","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DummyC  = new TH1D("H_hsdelta_DummyC","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsdelta_DummyCR  = new TH1D("H_hsdelta_DummyCR","; hsdelta;", 50, -20.0, 20.0);

  //LEFT1
  TH1D *hphL1  = new TH1D("hphL1","; ph_q;",50, -10, 370);      
  TH1D *hphL1R  = new TH1D("hphL1R","; ph_q;",  50, -10, 370);      
  TH1D *hphSL1  = new TH1D("hphSL1","; ph_q;",50, -10,370);      
  
  TH1D *hthL1  = new TH1D("hthL1","; th_q;",   50, -0.1, 0.1);      
  TH1D *hthL1R  = new TH1D("hthL1R","; th_q;",  50, -0.1, 0.1);      
  TH1D *hthSL1  = new TH1D("hth_qL1","; th_q;",   50, -0.1, 0.1);      

  TH1D *H_ssdelta_SL1  = new TH1D("H_ssdelta_SL1","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_SL1  = new TH1D("H_ssxptar_SL1","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_SL1  = new TH1D("H_ssyptar_SL1","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DL1  = new TH1D("H_ssdelta_DL1","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DL1  = new TH1D("H_ssxptar_DL1","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DL1  = new TH1D("H_ssyptar_DL1","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DL1R  = new TH1D("H_ssdelta_DL1R","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DL1R  = new TH1D("H_ssxptar_DL1R","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DL1R  = new TH1D("H_ssyptar_DL1R","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_hsdelta_SL1  = new TH1D("H_hsdelta_SL1","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_SL1  = new TH1D("H_hsxptar_SL1","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_SL1  = new TH1D("H_hsyptar_SL1","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DL1  = new TH1D("H_hsdelta_DL1","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DL1  = new TH1D("H_hsxptar_DL1","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DL1  = new TH1D("H_hsyptar_DL1","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DL1R  = new TH1D("H_hsdelta_DL1R","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DL1R  = new TH1D("H_hsxptar_DL1R","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DL1R  = new TH1D("H_hsyptar_DL1R","; hsyptar;", 50, -0.05, 0.05);

  //LEFT2
  TH1D *hphL2  = new TH1D("hphL2","; ph_q;",50, -10, 370);      
  TH1D *hphL2R  = new TH1D("hphL2R","; ph_q;",  50, -10, 370);      
  TH1D *hphSL2  = new TH1D("hphSL2","; ph_q;",50, -10, 370);      

  TH1D *hthL2  = new TH1D("hthL2","; th_q;",   50, -0.1, 0.1);      
  TH1D *hthL2R  = new TH1D("hthL2R","; th_q;",  50, -0.1, 0.1);      
  TH1D *hthSL2  = new TH1D("hth_qL2","; th_q;",   50, -0.1, 0.1);      

  TH1D *H_ssdelta_SL2  = new TH1D("H_ssdelta_SL2","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_SL2  = new TH1D("H_ssxptar_SL2","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_SL2  = new TH1D("H_ssyptar_SL2","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DL2  = new TH1D("H_ssdelta_DL2","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DL2  = new TH1D("H_ssxptar_DL2","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DL2  = new TH1D("H_ssyptar_DL2","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_ssdelta_DL2R  = new TH1D("H_ssdelta_DL2R","; ssdelta;", 50, -5.0, 3.0);
  TH1D *H_ssxptar_DL2R  = new TH1D("H_ssxptar_DL2R","; ssxptar;", 50, -0.06, 0.06);
  TH1D *H_ssyptar_DL2R  = new TH1D("H_ssyptar_DL2R","; ssyptar;", 50, -0.04, 0.04);

  TH1D *H_hsdelta_SL2  = new TH1D("H_hsdelta_SL2","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_SL2  = new TH1D("H_hsxptar_SL2","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_SL2  = new TH1D("H_hsyptar_SL2","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DL2  = new TH1D("H_hsdelta_DL2","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DL2  = new TH1D("H_hsxptar_DL2","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DL2  = new TH1D("H_hsyptar_DL2","; hsyptar;", 50, -0.05, 0.05);

  TH1D *H_hsdelta_DL2R  = new TH1D("H_hsdelta_DL2R","; hsdelta;", 50, -20.0, 20.0);
  TH1D *H_hsxptar_DL2R  = new TH1D("H_hsxptar_DL2R","; hsxptar;", 50, -0.1, 0.1);
  TH1D *H_hsyptar_DL2R  = new TH1D("H_hsyptar_DL2R","; hsyptar;", 50, -0.05, 0.05);
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHC; i++)
	...
	{
	  H_ssdelta_DC->Fill(P_gtr_dp-0.4);
...
////////////////////////////////////////////////////////
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEC; i++)
      ...
      if(CoinPionC && MMpiC && DiamondC)
	{
          ...
          hthepmeC->Fill(epsilonMEC-0.001);

          H_ssdelta_DmeC->Fill(P_gtr_dpmeC-0.2);
          H_ssxptar_DmeC->Fill(P_gtr_xptarmeC);
          H_ssyptar_DmeC->Fill(P_gtr_yptarmeC);

          H_hsdelta_DmeC->Fill(H_gtr_dpmeC-0.2);
          H_hsxptar_DmeC->Fill(H_gtr_xptarmeC);
          H_hsyptar_DmeC->Fill(H_gtr_yptarmeC+0.002);
     ...
     if(CoinPionCR && MMpiC && DiamondC)
       {
          ...
          hthepmeCR->Fill(epsilonMEC-0.001);

          H_ssdelta_DmeCR->Fill(P_gtr_dpmeC-0.2);
          H_ssxptar_DmeCR->Fill(P_gtr_xptarmeC);
          H_ssyptar_DmeCR->Fill(P_gtr_yptarmeC);

          H_hsdelta_DmeCR->Fill(H_gtr_dpmeC-0.2);
          H_hsxptar_DmeCR->Fill(H_gtr_xptarmeC);
          H_hsyptar_DmeCR->Fill(H_gtr_yptarmeC+0.002);
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEC; i++)

    {
      ...
      Double_t NFMC = 23135600/400000.0;
      //RadiativeStudy
  ...
  */
  Double_t ECMEC    = 1.0/249.1794;    // /1.05329;
  Double_t ECMEDC   = 1.0/34.8308;     ///1.05329;
