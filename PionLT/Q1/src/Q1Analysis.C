...
void Q1Analysis()
{
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEC; i++)

    {
      ...
      //Double_t NFMC = 22882700/400000.0;
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL1; i++)

    {
      ...
      //Double_t NFML1 = 24443600/400000.0;
  ...
  */
  ...
  TLine *lVK = new TLine(0.0, 0.9, 0.06, 0.9);
  // Customize the line appearance
  lVK->SetLineColor(kRed);
  lVK->SetLineStyle(2); // Dashed line
  lVK->SetLineWidth(2);
  hthtSmeC->Draw("E");
  lVK->Draw("same");
  cVK->Print(outputpdf);
