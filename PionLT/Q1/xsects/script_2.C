...
//  	 	c1->Update();
 ...
 //		TF2 *fff2 = new TF2("fff2","[0] + y*[1]", 0, 360, 0, 0.6);
		...
		//This is in use VK Aug 31 2025
		//TF2 *fff2 = new TF2("fff2","[0] + y*[1] + sqrt(2*y*(1+y))*[2]*cos(x*pi/180)  + y*[3]*cos(2*x*pi/180)", 11.25, 348.78, 0.26, 0.80 );       // VK

               // Change it iter. done
		TF2 *fff2 = new TF2("fff2","([0] + y*[1] + sqrt(2*y*(1+y))*[2]*cos(x*pi/180)  + y*[3]*cos(2*x*pi/180))/(2*TMath::Pi())", 11.25, 348.75, 0.238, 0.80);       // Aug 31, 2025 VK
