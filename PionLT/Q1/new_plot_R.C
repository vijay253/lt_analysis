...
TString outplot_dir = "new_ratio_check/";
TString outphiyield_dir = "new_ratio_check/";
TString ave_dir = "yields/";
...
//	exit(0);
	...
	file_name =  ave_dir + "yields." + file_name_str + "_+0000"+ ".target";

	//	TNtuple* n1 = new TNtuple("n1", "n1", "ratio:r_err:phi_bin:t_bin:y_exp:y_sim");
	TNtuple* n1 = new TNtuple("n1", "n1", "ratio:r_err:t_bin:phi_bin");
