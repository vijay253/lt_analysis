...
c      call xsect(+1,0.375,0.286)
c      call xsect(+1,0.375,0.629)
c      call xsect(+1,0.375,0.781)

      call xsect(+1,0.425,0.264)
      call xsect(+1,0.425,0.617)
      call xsect(+1,0.425,0.774)
...
c     1     *(1-fitpar(6)*tp*exp(fitpar(6)*tp))**4)/(q2**2)
...
c      sigT = (fitpar(1)+fitpar(2)*exp(-ftav))/(q2**2)

c      sigT = (fitpar(1)+fitpar(2)*exp(fitpar(3)*-ftav)
c     1    +fitpar(4)*exp(-ftav**2) )/(q2**2)

      sigT = (fitpar(1)+fitpar(2)*ftav**1+fitpar(3)*ftav**2) 
...
c     1     *exp(-q2))*ft*sin(thetacm)**2)
      sigTT = (((fitpar(12)/tp**3*exp(fitpar(13)*(tp))
...
* 1/(W^2-mp^2)^2.
c      wfactor=(2.200**2-mp**2)**2/(w**2-mp**2)**2
c      wfactor=1/(2.200**2-mp**2)**2
