...
void Q2Analysis()
{
  ...
  */
  ...
  Double_t tOffsetC   = 0.001387;
  Double_t tOffsetL1  = 0.001564;
  Double_t tOffsetL2  = 0.001497;
  ...
  //SIMC CENTER
  Double_t normfac = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q2_center.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCC; i++)

    {
      ...
      // Double_t fact = 10052700.0/400000.0;
  ...
  //SIMC LEFT1
  Double_t normfacL1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q2_left1.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCL1; i++)
    
    {
      ...
      //  Double_t factL1 = 10278200.0/400000.0;
      //RadiativeStudy
  ...
  //SIMC LEFT2
  Double_t normfacL2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_2p7_Q2_left2.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCL2; i++)
    
    {
      ...
      // Double_t factL2 = 10398100.0/400000.0;
      //RadiativeStudy
  ...
  **/
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECLEDCerr*ECLEDC),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
            {
              Yield = 0.0;
              YieldErr = 0;
  ...
  */
  ...
  Double_t tOffsetmeC   = 0.00031;
  Double_t tOffsetmeL1  = 0.000406;
  Double_t tOffsetmeL2  = 0.000583;  
  ...
  //SIMC CENTER
  Double_t normfacmeC = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q2_center.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEC; i++)

    {
      ...
      // Double_t NFMC = 22665800.0/400000.0;
      // Double_t NFMC = 22681900.0/400000.0;
      //RadiativeStudy
  ...
  //SIMC LEFT1
  Double_t normfacmeL1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q2_left1.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL1; i++)

    {
      ...
      //After applying SIMC offsets
      //Double_t NFML1 = 22814200.0/400000.0;
      //Double_t NFML1 = 22839900.0/400000.0;
      //RadiativeStudy
  ...
  //SIMC LEFT2
  Double_t normfacmeL2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_3p6_Q2_left2.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL2; i++)

    {
      ...
      //After applying SIMC offsets
      //Double_t NFML2 = 22823800.0/400000.0;
      //Double_t NFML2 = 22805800.0/400000.0;
      //RadiativeStudy    
  ...
  */
  ...
  TH2D *hYSheR2err   = new TH2D("hYSheR2err"," Yield SIMC R2;t-Bin; Phi-Bin ",  10, bins, 18, -22.5, 382.5);
  ...
  */ 
  ...
  Double_t tOffsetheR1 = 0.000305;
  Double_t tOffsetheR2 = 0.000292;
  Double_t tOffsetheC  = 0.000517;
  Double_t tOffsetheL1 = 0.000629;
  Double_t tOffsetheL2 = 0.000777;
  ...
  //SIMC RIGHT1
  Double_t normfacheR1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q2_right1.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHER1; i++)

    {
      ...
      //After applying SIMC offsets
      // Double_t NFR1 = 35654800.0/400000.0;
      // Double_t NFR1 = 35654800.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHER2; i++)
      ...
      if(CoinPionR2 && MMpiR2 && DiamondR2)
	{
          ...
          H_hsyptar_DheR2->Fill(H_gtr_yptarheR2);
      ...
      if(CoinPionR2R && MMpiR2 && DiamondR2)
	{
          ...
          H_hsyptar_DheR2R->Fill(H_gtr_yptarheR2);
  ...
  //SIMC RIGHT2
  Double_t normfacheR2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q2_right2.hist");
  Double_t NFR2 = normfacheR2/400000.0;
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHER2; i++)

    {
      ...
      //After applying SIMC offsets
      // Double_t NFR2 = 35318000.0/400000.0;
      // Double_t NFR2 = 35318000.0/400000.0;
      //RadiativeStudy
      ...
      if(CUTSIMCHER22)	
	{
	  ...
	  hYSheR2err->Fill(t_simcheR2,phipqheR2*57.2958);
  ...
  //SIMC CENTER
  Double_t normfacheC = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q2_center.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEC; i++)

    {
      ...
      //After applying SIMC offsets
      // Double_t NFC = 35902900.0/400000.0;
      // Double_t NFC = 35938300.0/400000.0;
      //RadiativeStudy
  ...
  //SIMC LEFT1
  Double_t normfacheL1 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q2_left1.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEL1; i++)

    {
      ...
      //After applying SIMC offsets
      // Double_t NFL1 = 35993800.0/400000.0;
      // Double_t NFL1 = 36011500.0/400000.0;
      //RadiativeStudy
  ...
  //SIMC LEFT2
  Double_t normfacheL2 = GetNormFactor("/group/c-kaonlt/USERS/vijay/simc_gfortran/outfiles/Pion_4p5_Q2_left2.hist");
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEL2; i++)

    {
      ...
      //After applying SIMC offsets
      // Double_t NFL2 = 36063400.0/400000.0;
      // Double_t NFL2 = 36066800.0/400000.0;
      //RadiativeStudy
  ...
  hthtSheR2->SetLineColor(kRed);
  hthtSheR2->Scale(SCFHER2);
  hthtSheR2->Draw("hist");
  // hththeR2->SetStats(0);
  hththeR2->Draw("same");
  ...
  **/
  ...
  TCanvas *phheR2 = new TCanvas("phheR2", "phheR2"); 
  //  hphheSR2->SetStats(0);
  hphheSR2->Scale(SCFHER2);
  hphheSR2->Draw("");
  // hphheR2->SetStats(0);
  ...
  hphheR2->Draw("same");
  phheR2->Print(outputpdf);

  TCanvas *phheRR2 = new TCanvas("phheRR2", "phheRR2"); 
  hphheR2->Divide(hphheSR2);
  hphheR2->Draw();
  phheRR2->Print(outputpdf);
  ...
  TCanvas *cdeltaHheR2 = new TCanvas("cdeltaHheR2", " cdeltaHheR2");
  //  H_hsdelta_SheR2->SetStats(0);
  H_hsdelta_SheR2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsdelta_SheR2->Scale(SCFHER2);
  H_hsdelta_SheR2->Draw("");
  ...
  TCanvas *cxptarSheR2 = new TCanvas("cxptarSheR2", " cxptarSheR2");
  // H_ssxptar_SheR2->SetStats(0);
  H_ssxptar_SheR2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssxptar_SheR2->Scale(SCFHER2);
  H_ssxptar_SheR2->Draw("");
  ...
  TCanvas *cyptarSheR2 = new TCanvas("cyptarSheR2", " cyptarSheR2");
  // H_ssyptar_SheR2->SetStats(0);
  H_ssyptar_SheR2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_ssyptar_SheR2->Scale(SCFHER2);
  H_ssyptar_SheR2->Draw("");
  ...
  TCanvas *cxptarHheR2 = new TCanvas("cxptarHheR2", " cxptarHheR2");
  // H_hsxptar_SheR2->SetStats(0);
  H_hsxptar_SheR2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsxptar_SheR2->Scale(SCFHER2);
  H_hsxptar_SheR2->Draw("");
  ...
  TCanvas *cyptarHheR2 = new TCanvas("cyptarHheR2", " cyptarHheR2");
  // H_hsyptar_SheR2->SetStats(0);
  H_hsyptar_SheR2->GetYaxis()->SetTitle("Yield (Events/mC)"); 
  H_hsyptar_SheR2->Scale(SCFHER2);
  H_hsyptar_SheR2->Draw("");
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYheR2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHER2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHER2err*ECHER2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
            {
              Yield = 0.0;
              YieldErr = 0;
            }
            YheR2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int j=1 ; j <=10 ; ++j) 
	...
	{
	  Double_t err;
	  Double_t TotNoEvent = hYhedR2->IntegralAndError(j, j, i, i, err, "");
	  Double_t Yield = TotNoEvent*ECHEDR2;
	  Double_t YieldErr = Yield*sqrt(pow((sqrt(TotNoEvent)/TotNoEvent),2) + pow((ECHEDR2err*ECHEDR2),2));    //Error progration in Yield
	  if (TotNoEvent <= 0)
            {
              Yield = 0.0;
              YieldErr = 0;
            }
            YdheR2<<Yield<<"\t"<<YieldErr<<"\t"<<j-1<<"\t"<<i-1 <<endl;
  ...
  for(int j=1 ; j <=10 ; ++j) 
      ...
      for(Long64_t i = 2; i <= 17; i++) 
	{
	  ...
	  Double_t err1;
          Double_t err2;
          Double_t TotNoEvent = hYSheR2err->IntegralAndError(j, j, i, i, err1, "");
          Double_t Y = hYSheR2->IntegralAndError(j, j, i, i, err2, "");
          Double_t Yerr = Y/sqrt(TotNoEvent);
          if (TotNoEvent <= 0)
            {
              Yerr = 0;
          ...
          YSheR2<<hYSheR2->IntegralAndError(j, j, i, i, err, "")<<"\t"<<Yerr<<"\t"<<j-1<<"\t"<<i-1 <<endl;
