...
void Q2Analysis()
{
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHL1; i++)
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  shleL1->Fill(-tL1*cos(ph_qL1), -tL1*sin(ph_qL1));	  
	}     
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCL1; i++)
    
    {
      ...
      Double_t factL1 = 9681860.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHL2; i++)
      ...
      if(CoinPionL2 && MMpiL2 && DiamondL2)
	{
	  ...
	  shleL2->Fill(-tL2*cos(ph_qL2), -tL2*sin(ph_qL2));	  
	}
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCL2; i++)
    
    {
      ...
      //After applying simc offsets
      Double_t factL2 = 9378980.0/400000.0;
      //RadiativeStudy
  ...
  */
  ...
  Double_t tOffsetmeC  = 0.000;
  Double_t tOffsetmeL1  = -0.0025;
  Double_t tOffsetmeL2  = -0.003;  
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEC; i++)
      ...
      if(CoinPionC && MMpiC && DiamondC)
	{
	  ...
	  shmeC->Fill(-tmeC*cos(ph_qmeC), -tmeC*sin(ph_qmeC));	  
	}	      
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEC; i++)

    {
      ...
      //After applying SIMC offsets
      Double_t NFMC = 22508500.0/400000.0;
      //RadiativeStudy
      ...
      if(CUTSIMCMEC)
	{
	  hthQ2SmeC->Fill(Q2_simcmeC, NFMC*WeightmeC);
          ...
          hthepSmeC->Fill(epsilon_simcmeC+0.002, NFMC*WeightmeC);
	  ...
	  //hYSmeC->Fill(t_simcmeC,missmassmeC, NFMC*WeightmeC);
          ...
          H_hsdelta_SmeC->Fill(hsdeltameC+1, NFMC*WeightmeC);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEL1; i++)
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  shmeL1->Fill(-tmeL1*cos(ph_qmeL1), -tmeL1*sin(ph_qmeL1));
	}
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL1; i++)

    {
      ...
      //After applying SIMC offsets
      Double_t NFML1 = 22495600.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHMIDEL2; i++)
	...
	
	{
	  ...
	  shmeL2->Fill(-tmeL2*cos(ph_qmeL2), -tmeL2*sin(ph_qmeL2));
	}
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCMIDEL2; i++)

    {
      ...
      //After applying SIMC offsets
      Double_t NFML2 = 22304600.0/400000.0;
      //RadiativeStudy    
  ...
  */
  ...
  Double_t tOffsetheR2 = 0.004;
  Double_t tOffsetheC = 0.002;
  Double_t tOffsetheL1 = -0.001;
  Double_t tOffsetheL2 = -0.002;
  ...
  */
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHER1; i++)
      ...
      if(CoinPionR1 && MMpiR1 && DiamondR1)
	{
	  ...
	  shheR1->Fill(-theR1*cos(ph_qheR1), -theR1*sin(ph_qheR1));
	}
      //Random
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHER1; i++)

    {
      ...
      Double_t NFR1 = 36049400.0/400000.0;
      //After applying SIMC offsets
      // Double_t NFR1 = 35928900.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHER2; i++)
      ...
      if(CoinPionR2R && MMpiR2 && DiamondR2)
	{
	  ...
	  hththeR2R->Fill(-theR2+tOffsetheR2);
	  htheR2R->Fill(-theR2);
	  htheInR2R->Fill(-theR2);
	  hph_qheR2R->Fill(ph_qheR2*57.2958 + 180);
	  hphheR2R->Fill(ph_qheR2*57.2958 + 180);
	  //hphheR2R->Fill(mmheR2+MMpiOffsetheR2);
	  hYheR2R->Fill(-theR2+tOffsetheR2, ph_qheR2*57.2958 + 180);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDR2; i++)
	...
	{
	  hYhedR2->Fill(-thedR2+tOffsetheR2, ph_qhedR2*57.2958 + 180);
	  //hYhedR2->Fill(-thedR2, mmhedR2+MMpiOffsetheR2);
	  hththedR2->Fill(-thedR2+tOffsetheR2);
	}
      //Random
	...
	{
	  hYhedR2R->Fill(-thedR2+tOffsetheR2, ph_qhedR2*57.2958 + 180);
	  //hYhedR2R->Fill(-thedR2, mmhedR2+MMpiOffsetheR2);
	  hththedR2R->Fill(-thedR2+tOffsetheR2);
	}      
    }    
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHER2; i++)

    {
      ...
      //      Double_t NFR2 = 36049300.0/400000.0;
            Double_t NFR2 =  36013400.0/400000.0;
      //After applying SIMC offsets
      // Double_t NFR2 = 36043800.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEC; i++)
      ...
      if(CoinPionCR && DiamondC)
	{
	  ...
	  hYheCR->Fill(-theC+tOffsetheC, ph_qheC*57.2958 + 180);
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEDC; i++)
      ...
      if(CoinPiondC && DiamonddC)
	{
      ...
      if(CoinPiondC && MMpidC && DiamonddC)
	{
	  hYhedC->Fill(-thedC+tOffsetheC, ph_qhedC*57.2958 + 180);
      ...
      if(CoinPiondCR && DiamonddC)
	{
      ...
      if(CoinPiondCR && MMpidC && DiamonddC)
	{
	  hYhedCR->Fill(-thedC+tOffsetheC, ph_qhedR1*57.2958 + 180);
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEC; i++)

    {
      ...
      //      Double_t NFC = 35824900.0/400000.0;
            Double_t NFC = 35938800.0/400000.0;
      //After applying SIMC offsets
      // Double_t NFC = 35781600.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEL1; i++)
      ...
      if(CoinPionL1 && MMpiL1 && DiamondL1)
	{
	  ...
	  shheL1->Fill(-theL1*cos(ph_qheL1), -theL1*sin(ph_qheL1));
	}      
      //Random
      if(CoinPionL1R && DiamondL1)
	{
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEL1; i++)

    {
      ...
      //      Double_t NFL1 = 35489900.0/400000.0;
            Double_t NFL1 = 35688700.0/400000.0;
      //After applying SIMC offsets
      // Double_t NFL1 = 35550500.0/400000.0;
      //RadiativeStudy
  ...
  for(Long64_t i = 0; i < nEntries_TBRANCHHIGHEL2; i++)
  ...
  
	{
	  ...
	  shheL2->Fill(-theL2*cos(ph_qheL2), -theL2*sin(ph_qheL2));
	}
  ...
  for(Long64_t i = 0; i < nEntries_TSIMCHIGHEL2; i++)

    {
      ...
      //      Double_t NFL2 = 35209500.0/400000.0;
      //After applying SIMC offsets
      // Double_t NFL2 = 35080300.0/400000.0;
      //RadiativeStudy
  ...
  inputFile14.close();
  /*
  Double_t ECHER1   = 1.5/effcharheR1;
  Double_t ECHEDR1  = 1.5/effcharheR1D;
  */
  ...
  inputFile16.close();
  /*
  Double_t ECHER2   = 2.0/effcharheR2;
  Double_t ECHEDR2  = 2.0/effcharheR2D;
  */
  ...
  inputFile20.close();
  /*
  Double_t ECHEL1   = 0.7/effcharheL1;
  Double_t ECHEDL1  = 0.7/effcharheL1D;
  */
  ...
  inputFile22.close();
  /*
  Double_t ECHEL2   = 0.7/effcharheL2;
  Double_t ECHEDL2  = 0.7/effcharheL2D;
  */  
