...
c      call average_r(+1,0.375,0.286)
c      call average_r(+1,0.375,0.629)
c      call average_r(+1,0.375,0.781)

      call average_r(+1,0.425,0.264)
      call average_r(+1,0.425,0.617)
      call average_r(+1,0.425,0.774)
