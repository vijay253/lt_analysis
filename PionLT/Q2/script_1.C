...
// 
// 	}
	Single_Setting(425,264);
	Single_Setting(425,617);
	Single_Setting(425,774);
...
//	exit(0);
	...
	label1.DrawLatex(0.45, 0.01, "#phi Bin");
	label1.SetTextAngle(90);
	label1.DrawLatex(0.02, 0.5, "Y_{exp}(true)/Y_{SIMC}");
	c1->Print(outplot_dir + "ratio_check_t_phi_bin" + file_name_str + ".pdf");
