...
# defining Cuts
if particle == "kaon":
    cuts = ["coin_epi_cut_prompt_noRF"]  # chagned to pion
if particle == "pion":
...
#    coin_ek_cut_rand_noRF_tmp = []
    ...
    for arr in Cut_COIN_Kaons_tmp:
        coin_ek_cut_prompt_noRF_tmp.append(c.add_cut(arr, "coin_epi_cut_prompt_noRF"))
#        coin_ek_cut_rand_noRF_tmp.append(c.add_cut(arr, "coin_epi_cut_rand_noRF"))
