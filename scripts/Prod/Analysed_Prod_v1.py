...
# I changed for Pion
        coin_ek_cut_all_noRF_tmp.append(c.add_cut(arr, "coin_epi_cut_all_noRF"))
        ...
        coin_ek_cut_all_RF_tmp.append(c.add_cut(arr, "coin_epi_cut_all_RF"))
        coin_ek_cut_prompt_RF_tmp.append(c.add_cut(arr, "coin_epi_cut_prompt_RF"))
        coin_ek_cut_rand_RF_tmp.append(c.add_cut(arr, "coin_epi_cut_rand_noRF"))  # coin_epi_cut_rand_RF not working right now
