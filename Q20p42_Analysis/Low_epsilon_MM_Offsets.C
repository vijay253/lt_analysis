...
void Low_epsilon_MM_Offsets()
{
  ...
  //Output file names
  TString foutname   = OutPath+"/" + "Low_Epsilon_MM_Qp425W2p2" + ".root";
  TString fouttxt    = OutPath+"/" + "Low_Epsilon_MM_Qp425W2p2" + ".txt";
  TString outputpdf  = OutPath+"/" + "Low_Epsilon_MM_Qp425W2p2" + ".pdf";
  ...
  */
  ...
  Double_t ECLEC  =   1.0/479.4377;
  Double_t ECLEL1 =   1.0/739.4706;
  Double_t ECLEL2 =   1.0/1077.307;
  //Scale Data Hist
  hmmC->Scale(ECLEC); 
  hmmwoC->Scale(ECLEC); 
  hmmL1->Scale(ECLEL1); 
  ...
  title->AddText("Low #epsilon , SHMS Center Setting");
  ...
  title1->AddText("Low #epsilon , SHMS Center Setting (with offset)");
  ...
  tleL1->AddText("Low #epsilon , SHMS Left1 Setting");
  ...
  tleL12->AddText("Low #epsilon , SHMS Left1 Setting (with offset)");
  ...
  tleL2->AddText("Low #epsilon , SHMS Left2 Setting");
  ...
  tleL22->AddText("Low #epsilon , SHMS Left2 Setting (with offset)");
