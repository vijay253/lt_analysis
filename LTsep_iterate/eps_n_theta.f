      subroutine eps_n_theta(npol,Eb,w,q2,tm,um,thetacm,eps)
...
c      thetacm2 = acos((m32 - m12 - 2*m22  + 2*(e1cm + m2) * e4cm  -  2*e1cm * m2)/(2 * p1cm * p4cm)) 
      ...
      print*, "Min Check: ", tmin, umin

      print*, "Angle Check: ", thetacm, thetacm1, thetacm + thetacm1
c      print*, "Angle Check other: ", thetacm3, thetacm2, thetacm2+thetacm3
